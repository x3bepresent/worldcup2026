...
const finishedMatches = JSON.parse(JSON.stringify(MATCH_DATA.todayMatches));
...
const RESULTS_DATA = {
  ...
  breakingNews: [
    ...
    {
      tag: 'LINEUP',
      text: '开幕战：Jiménez 梅开二度 · Ochoa 零封 · Gilberto Mora 首发搭档奏效',
      time: '6月12日',
    },
    {
      tag: 'LINEUP',
    ...
    {
      tag: 'REFEREE',
      text: 'Marciniak 4黄0红 · Sampaio 5黄 · 执法尺度与赛前模型一致',
      time: '裁判数据',
    },
  ],
  finishedMatches,
  groupSnapshots: [
    {
      ...
      label: 'A组 · 第1轮后',
      table: [
        { team: 'Mexico', pts: 3, p: 1, w: 1, d: 0, l: 0, gf: 2, ga: 0 },
        { team: 'South Korea', pts: 3, p: 1, w: 1, d: 0, l: 0, gf: 2, ga: 1 },
        { team: 'Czechia', pts: 0, p: 1, w: 0, d: 0, l: 1, gf: 1, ga: 2 },
        { team: 'South Africa', pts: 0, p: 1, w: 0, d: 0, l: 1, gf: 0, ga: 2 },
      ],
    },
  ],
};

function teamBlock(name, iso, rank, rating, form, coach, star, injuries, rumors) {
  return { name, iso, flag: '', fifa_rank: rank, rating, form, coach, star, injuries, rumors };
}
...
const todayMatches = [
  {
    ...
    home: teamBlock(
      'Canada', 'ca', 17, 78, ['W', 'W', 'W', 'D', 'W'], 'Jesse Marsch',
      {
      ...
      [
        { player: 'Jonathan David', status: 'FIT', note: '里尔前锋状态正佳，预计与 Buchanan 搭档锋线', confirmed: true },
      ],
      [
    ...
    away: teamBlock(
      'Bosnia and Herzegovina', 'ba', 55, 68, ['W', 'L', 'W', 'D', 'W'], 'Sergej Barbarez',
      {
        name: 'Edin Džeko',
        pos: 'ST',
        club: 'Fiorentina',
      ...
      [
        { player: 'Sead Kolašinac', status: 'DOUBT', note: '肌肉轻微拉伤，能否首发待赛前2小时确认', confirmed: false },
      ],
      [
    ...
    weather: {
      temp: 22, humidity: 65, altitude_m: 76, rain_chance: 20,
    ...
    mystic: {
      date_bazi: {
        year: '丙午年', month: '庚午月', day: '癸未日',
        day_summary: '癸未日——水土相涵，东道主如大地承载万民。《周易》曰：「厚德载物」，主场之利在此日尤为显著。',
        hour_home: '丑时（01:00-03:00）', hour_home_element: '土',
      },
      wuxing: {
        home: { team: 'Canada', colors: '红+白', elements: '火、金', verdict: '有利', verdict_color: '#5BBF8A', wuxing_short: '火金相生', reason: '加拿大红色属火，丑时土旺火生，主场气势如虹', advantage: '开场冲击力强' },
        away: { team: 'Bosnia and Herzegovina', colors: '蓝+白', elements: '水、金', verdict: '不利', verdict_color: '#D95F6A', wuxing_short: '水土相克', reason: '波黑蓝色属水，丑时土克水，客场气场受压', disadvantage: '开局易被动' },
        summary: '五行裁定：东道主火土顺局，波黑水土受制',
      },
      hexagram: {
        name: '泰卦', symbol: '☷', number: 11, quote: '《周易·泰卦》：「小往大来，吉亨。」',
        general: '天地交泰，主场小胜之象。利于顺势而行的一方。',
        advantage_team: 'Canada', disadvantage_team: 'Bosnia and Herzegovina',
        match_nature: '东道主小胜局', yellow_card_risk: '中',
        ...
        early_goal: { scenario: '若加拿大先进球', prediction: '泰卦「小往大来」——主队将扩大控球，波黑被迫压出，Davies 反击空间增大', favors: 'Canada', favors_prob: 68 },
        no_early_goal: { scenario: '若前30分钟无进球', prediction: 'Džeko 定位球成为波黑最大威胁，比赛进入消耗战', favors: 'Draw', favors_prob: 45 },
        away_goal: { scenario: '若波黑先进球', prediction: '加拿大主场反扑力度大，扳平概率58%，但逆转需防 Džeko 反击', favors: 'Canada', favors_prob: 52 },
        halftime: { scenario: '半场0-0', prediction: '下半场 Marsch 战术调整+主场声浪，加拿大进球概率65%', favors: 'Canada', favors_prob: 58 },
        extra_time: { scenario: '加时', prediction: '极低概率（8%）', favors: 'Canada', favors_prob: 55 },
      },
      home_score: 72, away_score: 38,
  ...
  },
  {
    ...
    home: teamBlock(
      'USA', 'us', 13, 79, ['W', 'W', 'D', 'W', 'W'], 'Mauricio Pochettino',
      {
      ...
      [
        { player: 'Weston McKennie', status: 'FIT', note: '尤文中场完全健康，将出任中路屏障', confirmed: true },
        { player: 'Sergiño Dest', status: 'DOUBT', note: '肌肉疲劳，可能轮换替补', confirmed: false },
      ],
      [
    ...
    away: teamBlock(
      'Paraguay', 'py', 52, 67, ['L', 'W', 'D', 'L', 'W'], 'Gustavo Alfaro',
      {
        name: 'Miguel Almirón',
        pos: 'CAM',
      ...
      [
        { player: 'Gustavo Gómez', status: 'FIT', note: '队长中卫伤愈复出，统领三中卫体系', confirmed: true },
      ],
      [
    ...
    weather: {
      temp: 28, humidity: 55, altitude_m: 30, rain_chance: 5,
      condition_cn: '晴朗，午后偏热',
      impact_level: 'MEDIUM',
      impact_summary: '28°C 午后气温对体能消耗有影响，Paraguay 南美球员适应性略优',
      home_adapt: 90, away_adapt: 75,
    ...
    mystic: {
      date_bazi: {
        ...
        hour_home: '巳时（09:00-11:00）', hour_home_element: '火',
      },
      wuxing: {
        home: { team: 'USA', colors: '白+蓝+红', elements: '金、水、火', verdict: '有利', verdict_color: '#5BBF8A', wuxing_short: '火金土旺', reason: '美国队服多色，巳时火旺，主场气势正盛', advantage: '上半场压制力强' },
        away: { team: 'Paraguay', colors: '白+蓝+红', elements: '金、水、火', verdict: '中性', verdict_color: '#C8A96E', wuxing_short: '同色相对', reason: '两队队服五行相近，比拼纯竞技与战术', disadvantage: '客场气场略逊' },
        summary: '五行裁定：美国火时顺局，巴拉圭同色相争需靠防守',
      },
      hexagram: {
        name: '大有卦', symbol: '☲', number: 14, quote: '《周易·大有卦》：「自天佑之，吉无不利。」',
        general: '火在天上，光明盛大。利于占据主场、气势正盛的一方。',
        advantage_team: 'USA', disadvantage_team: 'Paraguay',
        match_nature: '东道主控场局', yellow_card_risk: '低',
        ...
        early_goal: { scenario: '若美国先进球', prediction: '大有卦「自天佑之」——主队将完全掌控节奏，Paraguay 被迫压出，反击空间打开', favors: 'USA', favors_prob: 72 },
        no_early_goal: { scenario: '若前45分钟无进球', prediction: 'Paraguay 5-3-2 奏效，下半场美国体能+换人成为关键', favors: 'USA', favors_prob: 55 },
        away_goal: { scenario: '若巴拉圭反击破门', prediction: '美国主场声浪下反扑猛烈，扳平概率65%', favors: 'USA', favors_prob: 58 },
        halftime: { scenario: '半场0-0', prediction: 'Pochettino 半场调整+球迷压力，美国下半场破门概率70%', favors: 'USA', favors_prob: 62 },
        extra_time: { scenario: '加时', prediction: '极低（5%）', favors: 'USA', favors_prob: 60 },
      },
      home_score: 78, away_score: 35,
...
const NEW_MATCH_DATA = {
  ...
  syncSource: 'manual',
  breakingNews: [
    { tag: 'OFFICIAL', text: '📅 今日赛事 · 加拿大 vs 波黑（03:00）· 美国 vs 巴拉圭（09:00）· 北京时间 6月13日', time: '今日赛程' },
    { tag: 'LINEUP', text: '加拿大：Davies 左路锁定首发，Jonathan David 领衔锋线；Marsch 确认 4-3-3 攻击阵型', time: '赛前情报' },
    { tag: 'INJURY', text: '波黑：Kolašinac 肌肉拉伤存疑，Džeko 完全健康将首发担任支点', time: '伤情快报' },
    { tag: 'OFFICIAL', text: '美国：Pulisic 队长领衔，Pochettino 排出 4-3-3；McKennie 坐镇中场', time: '官方消息' },
  ...
  nextMatch: {
    ...
    home: { name: 'Qatar', iso: 'qa', fifaRank: 68, rating: 60 },
    away: { name: 'Switzerland', iso: 'ch', fifaRank: 19, rating: 77 },
...
console.log('✅ results-data.js:', finishedMatches.length, 'finished matches');
console.log('✅ matches-data.js:', todayMatches.length, 'today matches');
