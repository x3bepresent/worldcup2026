...
// Last updated: 2026-06-21T12:25:40+08:00
const MATCH_DATA = {
  "lastUpdated": "2026-06-21T12:25:40+08:00",
  "syncSource": "FIFA 赛程 · Day 11 · weather/injuries/coach/referee enriched",
  "breakingNews": [
    {
      "tag": "OFFICIAL",
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "model_total_xg": 2.56,
            "totals_line_gap": 0.5,
            "totals_high_pct": 46.8,
            "totals_low_pct": 53.2,
            "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
            "win_low_total_pct": 23.2,
            "win_margin2_low_total_pct": 10.5,
            "win_margin2_high_total_pct": 18.4,
            "readout_cn": "取胜约 59%；若取胜，以「险胜收工」为主（46.5%）。 对着赛前净胜参考，净胜≥1（全达标）约 54%；对着总进球参考 2.5，模型超线概率约 46.8%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            ...
            "spread": {
              ...
              "detail_cn": "Belgium · 赛前外界预期 净胜≥1。模型推演达标概率约 54%；模型认为达到外界预期档的概率相对较高。",
              "extra_stats_cn": "",
              "full_cover_pct": 54,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "Belgium 已 1-0 领先：仍取胜约 78.6%。 对着总进球参考 2.5，模型超线概率约 48.5%。 常见 2-0 收尾（相对总进球参考 2.5仍偏小比分）。"
              }
            },
            {
              "side": "away",
        ...
        "public_summary_note": "【推演概要】Belgium · 低位反击。 · 与模型 xG 对照：实力吻合 · 赛前净胜看法高于 xG 隐含约 0.5（模型微调：主胜 +2% · 平 -1% · 客 -1%）",
        "goal_efficiency_preview": {
          "mode": "preview",
          "xg_total": 2.97,
          "xg_gap": 0.87,
