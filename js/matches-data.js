  ...
  "todayMatches": [
    {
      ...
      "prediction": {
        ...
        "xg_home": 3.8,
        "xg_away": 0.3,
        "key_factor": "实力悬殊局：德国 xG 3.8 对 0.3，Musiala/Wirtz 对位 Advocaat 五后卫低位。Neuer 复出五届世界杯；库拉索人口最少参赛国，目标零封前 30 分钟。泊松最可能 3-0/4-0。",
        "score_dist": [
          {
            "score": "3-0",
            "prob": 15.2
    ...
    },
    {
      ...
      "prediction": {
        ...
        "xg_home": 1.85,
        "xg_away": 1.05,
        "key_factor": "F组技术流对决：荷兰边路宽度（Gakpo/Dumfries）对位日本三中卫；Kubo 肋部是日本唯一稳定破局点。de Jong 控球 vs Kamada 逼抢决定节奏。xG 1.85-1.05 泊松最可能 2-1。",
        "score_dist": [
          {
            "score": "1-1",
            "prob": 10.7
    ...
    },
    {
      ...
      "prediction": {
        ...
        "xg_home": 1.5,
        "xg_away": 1.4,
        "key_factor": "E组硬碰硬：科特迪瓦身体对抗 vs 厄瓜多尔 19 场不败纪律。Caicedo-Kessié 对位决定中场；xG 1.5-1.4 几乎均势，泊松最可能 1-1，次选 2-1 主队。",
        "score_dist": [
          {
            "score": "1-1",
            "prob": 11.6
