...
// Last updated: 2026-06-14T18:30:00+08:00
const MATCH_DATA = {
  "lastUpdated": "2026-06-14T18:30:00+08:00",
  "syncSource": "manual+media",
  "breakingNews": [
    {
      "tag": "OFFICIAL",
    ...
    {
      "tag": "OFFICIAL",
      "text": "🏁 昨日：加拿大 1-1 波黑 · 美国 4-1 巴拉圭 · B组加拿大/波黑各1分",
      "time": "赛果回顾"
    },
    {
      "tag": "REFEREE",
  ...
  "todayMatches": [
    {
      ...
      "mystic": {
        ...
        "hexagram": {
          ...
          "scenarios": [
            { "icon": "⚽", "label": "比赛性质", "text": "瑞士客胜58%，平局24%，卡塔尔爆冷18%" },
            { "icon": "⏱", "label": "进球高峰", "text": "第25-40分钟及第70-85分钟——瑞士转移提速段" },
            { "icon": "🟨", "label": "黄牌风险", "text": "中等——卡塔尔防守三区犯规增多" },
            { "icon": "🔄", "label": "0-0平局可能", "text": "低（约12% 泊松）——瑞士破局手段明显更多" },
            { "icon": "⏰", "label": "加时赛概率", "text": "极低（5%）——90分钟内分胜负概率95%" }
          ],
          "early_goal": {
            "scenario": "若瑞士先进球",
    ...
    },
    {
      ...
      "mystic": {
        ...
        "hexagram": {
          ...
          "scenarios": [
            { "icon": "⚽", "label": "比赛性质", "text": "巴西主胜58%，平局25%，摩洛哥爆冷17%" },
            { "icon": "⏱", "label": "进球高峰", "text": "第15-30分钟及第60-75分钟——双方对攻最激烈时段" },
            { "icon": "🟨", "label": "黄牌风险", "text": "中等偏高——边路对位+中场绞杀" },
            { "icon": "🔄", "label": "0-0平局可能", "text": "低（约8% 泊松）——双方 xG 合计超3" },
            { "icon": "⏰", "label": "加时赛概率", "text": "极低（6%）——C组焦点战倾向90分钟见分晓" }
          ],
          "early_goal": {
            "scenario": "若巴西先进球",
    ...
    },
    {
      ...
      "mystic": {
        ...
        "hexagram": {
          ...
          "scenarios": [
            { "icon": "⚽", "label": "比赛性质", "text": "苏格兰客胜50%，平局28%，海地爆冷22%" },
            { "icon": "⏱", "label": "进球高峰", "text": "第55-70分钟——海地体能下降、苏格兰加强远射" },
            { "icon": "🟨", "label": "黄牌风险", "text": "低至中——战术犯规为主，激烈程度有限" },
            { "icon": "🔄", "label": "0-0平局可能", "text": "中（约18% 泊松）——海地密集防守可拖入僵局" },
            { "icon": "⏰", "label": "加时赛概率", "text": "极低（4%）——低比分局仍倾向90分钟分胜负" }
          ],
          "early_goal": {
            "scenario": "若苏格兰先进球",
    ...
    },
    {
      ...
      "mystic": {
        ...
        "hexagram": {
          ...
          "scenarios": [
            { "icon": "⚽", "label": "比赛性质", "text": "澳大利亚38%，平局28%，土耳其34%——最接近的今日场次" },
            { "icon": "⏱", "label": "进球高峰", "text": "第20-35分钟及第75-90分钟——双方体能消耗后易出错" },
            { "icon": "🟨", "label": "黄牌风险", "text": "中等——Irvine-Çalhanoğlu 中路对位+定位球争抢" },
            { "icon": "🔄", "label": "0-0平局可能", "text": "中（约15% 泊松）——双方均有破门手段" },
            { "icon": "⏰", "label": "加时赛概率", "text": "极低（3%）——小组赛首轮仍分胜负为主" }
          ],
          "early_goal": {
            "scenario": "若澳大利亚先进球",
