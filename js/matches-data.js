  ...
  "todayMatches": [
    ...
    },
    {
      ...
      "prediction": {
        ...
        "qual_dynamics": null,
        "xg_poisson_home": 0.59,
        "xg_poisson_away": 2.25,
        "xg_tier_calibrated": true,
        "score_prob": 14.8,
        "score_top3": [
          {
      ...
      "depth_calibration": {
        "tier_home": -1.25,
        "tier_label": "France -1.25 · Paraguay +1.25",
        "implied_tier": -0.75,
        "tier_gap": -0.5,
        ...
        "blocker_spread_note": "",
        "public_lean_cn": "舆论倾向 France（约 79%）",
        ...
        "spread_cover": {
          ...
          "dog_hold_pct_raw": 62.1
        },
        "spread_odds": {
          "fav": 0.9,
          "dog": 0.92,
          "note": "Paraguay 0.9 · France 0.92"
        },
        "spread_alt": null,
        "totals_analysis": {
          "market_line": 2.5,
          ...
          "index_note": "大/小比分两侧接近",
          "totals_odds": null,
          "rational_cn": "超 2.5 球接近五五开（约 50%）",
          "score_link_cn": "小比分 1-0/1-1 · 2-0/2-1 居中 · 3球+ 大比分"
        },
        "totals_line": 2.5,
        "market_line_movement": {
          "wc_note": "世界杯中立赛场 · FIFA 主/客仅为赛历标签，不等于真实主场优势",
          "spread_open_cn": "Paraguay +1/1.5@0.92 · France -1/1.5@0.9",
          "spread_now_cn": "Paraguay +1/1.5@0.92 · France -1/1.5@0.9",
          "totals_now_cn": "大小 2.5 · 大 0.92 / 小 0.88",
          "tag": "correction",
          "tag_cn": "向模型修正",
          "tag_color": "#C8A96E",
          "detail_cn": "退 2.5 档 · 热门 0.9→0.9 · 受让 0.92→0.92 现盘去水隐含：France 50.3% · Paraguay 49.7%（超收 4.7%） 模型穿盘（现档 France -1.25 · Paraguay +1.25）：France 46.9% · Paraguay 53.1% 模型−市场：France -3.4pp · Paraguay +3.4pp 期望 ROI@现水：France -23.6% · Paraguay +30.7% 盘路向 xG 隐含档位收敛，属于定价修正而非单向诱盘。",
          "actuarial": {
            "actuarial_type": "correction",
            "actuarial_cn": "向模型修正",
            "actuarial_color": "#C8A96E",
            "actuarial_desc": "盘路向 xG 隐含档位收敛，属于定价修正而非单向诱盘。",
            "summary_cn": "退 2.5 档 · 热门 0.9→0.9 · 受让 0.92→0.92 现盘去水隐含：France 50.3% · Paraguay 49.7%（超收 4.7%） 模型穿盘（现档 France -1.25 · Paraguay +1.25）：France 46.9% · Paraguay 53.1% 模型−市场：France -3.4pp · Paraguay +3.4pp 期望 ROI@现水：France -23.6% · Paraguay +30.7% 盘路向 xG 隐含档位收敛，属于定价修正而非单向诱盘。",
            "line_delta": -2.5,
            "line_delta_cn": "退 2.5 档",
            "fav_odds_delta": 0,
            "dog_odds_delta": 0,
            "water_move_cn": "热门 0.9→0.9 · 受让 0.92→0.92",
            "open_tier": 1.25,
            "open_tier_label": "Paraguay -1.25 · France +1.25",
            "now_tier": -1.25,
            "implied_tier": -0.75,
            "open_tier_gap": 2,
            "now_tier_gap": -0.5,
            ...
            "model_cover_open_pct": 15.1,
            "model_cover_now_pct": 46.9,
            "model_dog_cover_now_pct": 53.1,
            "market_fav_cover_now_pct": 50.3,
            "market_dog_cover_now_pct": 49.7,
            "model_vs_market_fav_pp": -3.4,
            "model_vs_market_dog_pp": 3.4,
            "fav_roi_pct": -23.6,
            "dog_roi_pct": 30.7,
            "fav_name": "France",
            "dog_name": "Paraguay"
        ...
        "agent_pick": {
          ...
          "spread": {
            "side": "dog",
            "label_cn": "巴拉圭 +1/1.5 @0.92",
            "reason_cn": "Alfaro 低位铁桶（点球淘汰德国）· 法国破深防常见 1-0/2-1 · 0-1/1-1 受让守住 · ★主项。"
          },
          "totals": {
            "side": "over",
            "label_cn": "大球 2.5 @0.92",
            "reason_cn": "法国锋线火力足 · 若早破门易大 · 副项（R9不打副项小）。",
        ...
        "display_summary": {
          ...
          "calibration": {
            ...
            "market_tier_label": "France -1.25 · Paraguay +1.25",
            "summary_cn": "与模型 xG 对照：预期偏热 · 赛前净胜看法低于 xG 隐含约 0.5 · 模型认为仅小胜 1 球仍约 25.6%"
          },
          "win_outlook": {
            "fav_name": "France",
            "state_label": null,
            ...
            "model_total_xg": 2.63,
            "totals_line_gap": 0.5,
            "totals_high_pct": 48.3,
            "totals_low_pct": 51.7,
            "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
            "win_low_total_pct": 25.5,
            "win_margin2_low_total_pct": 12.2,
            "win_margin2_high_total_pct": 23.4,
            "readout_cn": "取胜约 60%；若取胜，以「险胜收工」为主（42%）。 对着赛前净胜参考，净胜≥2（全达标）约 45.7%；对着总进球参考 2.5，模型超线概率约 48.3%。 2-0 类：净胜扩大但总进球仍可能低于总进球参考 2.5。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            "headline_cn": "France -1.25 穿盘：有达标可能",
            "sub_cn": "France 胜 61.7% · 胜后穿 58.5% · Paraguay +1.25 守 54% 进球氛围：几乎五五开",
            "spread": {
              "level": "possible",
              "label_cn": "有达标可能",
              "color": "#C8A96E",
              "fav_name": "France",
              "dog_name": "Paraguay",
              "fav_handicap_cn": "France -1.25",
              "dog_handicap_cn": "Paraguay +1.25",
              "market_expect_cn": "France -1.25 · 净胜≥2",
              "meet_pct": 46,
              "dog_hold_pct": 54,
              "fav_win_pct": 61.7,
              "cover_given_win_pct": 58.5,
              "full_cover_pct_raw": 36.1,
              "meet_pct_label": "France -1.25 穿盘概率（校准）",
              "dog_hold_label": "Paraguay +1.25 守住概率（校准）",
              "two_stage_cn": "France 取胜约 61.7% · 赢球后穿盘约 58.5% · Paraguay +1.25 守住约 54%",
              "grid_tail_pct": null,
              "verdict_cn": "有达标可能",
              "headline_cn": "France -1.25 穿盘：有达标可能",
              "pill_cn": "France 胜 61.7% · 胜后穿 58.5% · Paraguay +1.25 守 54%",
              "detail_cn": "France 取胜约 61.7% · 赢球后穿盘约 58.5% · Paraguay +1.25 守住约 54%（泊松 raw 36.1% → 校准 46%）；穿盘与受让守住均有一定空间（仅胜 1 球约 25.6%）。",
            ...
            "pills": [
              {
                ...
                "text": "France 胜 61.7% · 胜后穿 58.5% · Paraguay +1.25 守 54%",
                "color": "#C8A96E",
                "primary": true
              },
              {
          ...
          "first_goal_scenarios": [
            ...
            },
            {
              ...
              "live_outlook": {
                ...
                "totals_high_pct": 62.1,
                "totals_low_pct": 37.9,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 29.4,
                "win_margin2_low_total_pct": 17.2,
                "win_margin2_high_total_pct": 36.8,
                "readout_cn": "France 已 1-0 领先：仍取胜约 81.5%。 对着总进球参考 2.5，模型超线概率约 62.1%。 常见 2-0 收尾（相对总进球参考 2.5仍偏小比分）。"
              }
            }
          ],
          "match_preview": {
        ...
        "public_summary_note": "【推演概要】France · 压制局。 · 与模型 xG 对照：预期偏热 · 赛前净胜看法低于 xG 隐含约 0.5 · 模型认为仅小胜 1 球仍约 25.6%（模型微调：主胜 +2% · 平 +1% · 客 -3%）",
        "goal_efficiency_preview": {
          "mode": "preview",
          "xg_total": 2.7,
          "xg_gap": 1.1,
          ...
          "pattern_note": "样本：弱队效率<0.6 时总进球难破 3；xG 差≥1.0 时小比分更常见。",
          "summary_cn": "【路径·基准 xG】合计 2.7 · France 1.9 / Paraguay 0.8 → 主路径「铁局/小比分」约 54%。 超 2.5 约 50% · ≤2球 50%。样本：弱队效率<0.6 时总进球难破 3；xG 差≥1.0 时小比分更常见。",
          "in_mid_band": true,
          "sample_note": "结构规则来自已赛 22 场（xG 2.0–3.0 · 排除 m27）· 大/小标签用基准 xG 泊松 ≥60%/≤40%"
        }
      },
      "market_snapshot": {
        ...
        "cover_given_win_pct": 58.5,
        "spread_level": "possible",
        "spread_market_expect": "France -1.25 · 净胜≥2",
        "line_move_tag": "correction",
        "line_move_cn": "向模型修正",
        "agent_pick_primary": "spread",
        "agent_pick_tendency_cn": "更倾向让球盘（巴拉圭受让）",
        "agent_pick_confidence": "medium",
        "agent_spread_cn": "巴拉圭 +1/1.5 @0.92",
