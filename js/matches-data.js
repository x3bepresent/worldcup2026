...
const MATCH_DATA = {
  ...
  "breakingNews": [
    {
      "tag": "OFFICIAL",
      "text": "🏁 巴西 1-1 摩洛哥 · Saibari 21' · Vinícius 32' · C组两队各1分",
      "time": "赛果"
    },
    {
      "tag": "LINEUP",
    ...
    {
      "tag": "OFFICIAL",
      "text": "📅 今日余2场 · 海地-苏格兰(09:00) · 澳-土(12:00) · 北京时间6月14日",
      "time": "赛程"
    },
    {
      "tag": "PREVIEW",
      "text": "明日 · 德国-库拉索(01:00) Neuer先发 · 荷兰-日本(04:00) · 科特-厄瓜(07:00)",
      "time": "下三场"
    },
    {
      "tag": "OFFICIAL",
      "text": "🏁 卡塔尔 1-1 瑞士 · Khoukhi 90+4' 绝平 · B组四队各1分",
      "time": "回顾"
    },
    {
      "tag": "UPDATE",
      "text": "巴西 opener 20 场不败延续但 xG 1.27-1.52 憾平 · Douglas Santos 7.8",
      "time": "复盘"
    }
  ],
  "todayMatches": [
  ...
  "nextMatch": {
    ...
    "lineup": {
      ...
      "predicted": {
        ...
        "home": "Neuer; Kimmich, Tah, Schlotterbeck, Raum; Goretzka, Pavlović; Sané, Musiala, Wirtz; Havertz",
        "away": "Room; Sambo, Gaari, Obispo, Floranus; J. Bacuna, Comenencia, L. Bacuna; Chong, Locadia, Gorré",
        "source": "FotMob Predicted · 2026-06-14 · 非官方"
      }
    },
    "teaser": "E组揭幕：Neuer 复出确认先发，德国对阵世界杯首秀库拉索。FotMob 预测 4-2-3-1，Musiala-Wirtz 双核。",
    "home_win": 82,
    "draw": 12,
    "away_win": 6,
    "predicted_score": "3-0",
  ...
  "upcomingMatches": [
    {
      ...
      "lineup": {
        ...
        "predicted": {
          ...
          "home": "Verbruggen; Dumfries, van Hecke, van Dijk, van de Ven; de Jong, Reijnders, Gravenberch; Summerville, Malen, Gakpo",
          "away": "Suzuki; Itakura, Ito, Watanabe; Doan, Kamada, Sano, Nakamura; Kubo, Ito; Ueda",
          "source": "FotMob Predicted · 2026-06-14"
        }
      },
      "teaser": "F组焦点：Verbruggen 乌兹别克热身碰撞后存疑；日本队长远藤航已退出大名单。",
      "note": "较上次无官方 XI 变化，仍 Predicted"
    },
    {
      "group": "E",
      ...
      "teaser": "厄瓜多尔 19 场不败；科特迪瓦 Evan N'Dicka 伤疑缺阵。",
      "note": "较上次无变化，仍 Predicted"
    }
  ]
};
