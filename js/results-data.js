...
const RESULTS_DATA = {
  ...
  "syncSource": "FIFA 官方赛果 · Day 8 完结 · Day 9 预览",
  "breakingNews": [
    {
      "tag": "OFFICIAL",
    ...
    {
      "tag": "OFFICIAL",
      "text": "墨西哥锁定 32 强 · David 帽子戏法 · Manzambi 替补双响",
      "time": "球星"
    },
    {
      "tag": "OFFICIAL",
      "text": "A组墨西哥 6 分 · B组加拿大&瑞士 4 分",
      "time": "积分榜"
    },
    {
      "tag": "PREVIEW",
      "text": "📅 6月20日 · 美国-澳(03:00) · 苏-摩(06:00) · 巴-海(09:00) · 土-巴(11:00)",
      "time": "今日赛程"
    },
    {
      "tag": "OFFICIAL",
  ...
  "finishedMatches": [
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "✅ FIFA 官方 team sheet（FotMob 2026-06-15 赛前确认） · 全场 1-1",
        "predicted": {
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "📋 FotMob 最新预测阵容（官方名单开赛前约1小时公布 · 非最终确认） · 全场 1-1",
        "predicted": {
          "formation": "4-2-3-1 / 4-3-3",
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "📋 FotMob 最新预测阵容（官方名单开赛前约1小时公布 · 非最终确认） · 全场 2-2",
        "predicted": {
          "formation": "4-3-3 / 4-4-2",
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "✅ 官方首发已确认（The Standard / BBC · 2026-06-16 赛前 team sheet） · 全场 3-1 · FotMob xG 约 1.8–0.9 · 半场 0-0 后法国掌控",
        "source": "FIFA team sheet · The Standard",
        "updated": "2026-06-17T23:30:00+08:00",
        "diff": {
          "home": "⚠️ 实际 4-2-3-1（非 4-3-3）：Rabiot+Tchouaméni 双闸 · Olise 右翼 + Dembélé 10 号 + Doué 左路 · Kanté/Thuram/Griezmann 替补",
          "away": "⚠️ Mendy 一门（非 Diouf）· Niakhate 中卫 · Gana Gueye 后腰 · Ismaila Sarr 首发（非 Iliman Ndiaye）"
        },
        "predicted": {
          "formation": "4-3-3 / 4-3-3",
      ...
      "home": {
        ...
        "stars": [
          {
            ...
            "pos": "ST",
            "club": "Real Madrid",
            "stats": "2球 · 追平/超越 Giroud",
            "rating": 9,
            "desc": "66'+90+6' 双响 · 队史射手王(58) · MOTM"
          },
          {
            "name": "Michael Olise",
            "pos": "RW",
        ...
        "injuries": [
          ...
          },
          {
            ...
            "status": "FIT",
            "note": "与 Tchouaméni 组成双闸，Kanté 替补",
            "confirmed": true
          },
          {
            "player": "Antoine Griezmann",
            "status": "BENCH",
            "note": "未进首发，Cherki/Thuram/Barcola 待命",
            "confirmed": true
          }
        ],
        "rumors": [
      ...
      "depth_calibration": {
        ...
        "spread_cover": {
          ...
          "over_2_5_pct": 60.8,
          "over_3_pct": 37.9,
          "totals_lean_cn": "2.5 球参考偏多进球（约 60.8%）；3 球参考偏少",
        ...
        "totals_analysis": {
          ...
          "index_note": "多进球侧 1 / 少进球侧 0.88 · 少进球侧关注度更高",
          "totals_odds": {
            "over": 1,
            "under": 0.88,
            "note": "多进球 1 · 少进球 0.88"
          },
          "rational_cn": "模型略倾向多进球（总进球约 2.5–3 个 约 60.8%）",
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 63%；若取胜，以「开放拉开」为主（36.1%）。 对着赛前净胜参考，净胜≥2（全达标）约 44.1%；对着外界总进球参考 总进球约 2.5–3 个，模型终场多于该参考的概率约 49.3%。"
          },
          "totals_line": 2.75,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 3.1 球（公允参考约 2.75） · 外界总进球参考 2.75 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "France · 净胜走向：有达标可能",
            "sub_cn": "达标概率约 44.1% · 有达标可能 进球氛围：略倾向精彩（弱信号）",
            "spread": {
              "level": "possible",
              "label_cn": "有达标可能",
              "color": "#C8A96E",
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": 13.5,
              "small_delta": 3.3,
              "narrative": "France 先破门（已 1-0） → 「控节奏 · 适度轮换」；Senegal 「Mané 单核」。领先后双方可能转入守势，比分差距不易再拉大。",
              "live_outlook": {
                "fav_name": "France",
                ...
                "totals_low_pct": 53.6,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 32.2,
                "win_margin2_low_total_pct": 19,
                "win_margin2_high_total_pct": 38.6,
                "readout_cn": "France 已 1-0 领先：仍取胜约 84.7%。 对着外界总进球参考 总进球约 2.5–3 个，模型终场多于该参考的概率约 46.4%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
              ...
              "excitement": {
                ...
                "label_key": "fast",
                "label_color": "#5BBF8A",
                "sub_cn": "预期首球等待约 27.2 分",
                "first_goal_wait": 27.2,
                "fast_pct": 59.5,
                "moderate_pct": 14.7,
                "slow_pct": 25.7,
                "tiers": [
              ...
              "big_delta": -21,
              "small_delta": -1.5,
              "narrative": "Senegal 先破门（已 0-1） → 「4-5-1 收缩」；France 「堆边锋 · 肋部渗透」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 3.1 球（公允参考约 2.75） · 外界总进球参考 2.75 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2.5–3 个",
              "totals_high_pct": 49.3,
              "type_tags": [
                {
              ...
              "depth_label": "板凳深度偏高",
              "draw_trap_pct": 38,
              "readout_cn": "France · 压制局 · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
            "draw_trap_note": "平局风险：低位反击队若先进球或被追平，1-1 / 0-0 比客胜更现实（约 38% 冷门空间含平局）。",
            "archetype": {
              "tags": [
                {
                  "key": "dominance",
        ...
        "public_summary_note": "【推演概要】France · 压制局 · 低位反击。 · 与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 0.5 · 模型认为仅小胜 1 球仍约 23.8%（模型微调：主胜 -4% · 平 +1% · 客 +3%）",
        "preview_replay": {
          "actual_score": "3-1",
          "ht_score": "0-0",
          "hits": [
      ...
      "group_context": {
        ...
        "scenarios": [
          "France 若取胜：积分 6，I 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Senegal 若取胜：积分 3，客场抢分将改变 I 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 E 组：头名 Germany 3 分 · 次席 Côte d'Ivoire 同分（32强绑定组） · J 组：头名 Argentina 3 分 · 次席 Austria 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
        "home_score": 3,
    ...
    },
    {
      ...
      "lineup": {
        ...
        "updated": "2026-06-17T23:45:00+08:00",
        "diff": {
        ...
        "injuries": [
          {
            "player": "Jalal Hassan",
            "status": "FIT",
            "note": "队长 · 一门首发（Raed 未出场）",
            "confirmed": true
          },
          {
            "player": "Aymen Hussein",
            "status": "FIT",
            "note": "39' 头球破门 · 90+7' 乌龙",
            "confirmed": true
          }
        ],
        "rumors": [
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 59%；若取胜，以「险胜收工」为主（44.3%）。 对着赛前净胜参考，净胜≥2（全达标）约 32.5%；部分达标净胜=1 约 25.9%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 46.2%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.5 球（公允参考约 2） · 外界总进球参考 2.5，高出模型约 0.5 球 · 外界参考略高于模型公允线（+0.5 球） · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": -18.7,
              "small_delta": -6.5,
              "narrative": "Iraq 先破门（已 1-0） → 「5-4-1 铁桶」；Norway 「堆前锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            },
            {
              "side": "away",
              ...
              "big_delta": 24.6,
              "small_delta": 1,
              "narrative": "Norway 先破门（已 0-1） → 「继续进攻」；Iraq 「维持低位」。领先方继续进攻，仍有较大空间扩大比分。",
              "live_outlook": {
                "fav_name": "Norway",
                ...
                "margin_line_cn": "Norway · 赛前净胜参考 净胜≥2（全达标） · 部分达标净胜=1",
                "margin_meet_pct": 57.1,
                "margin_half_pct": 26.9,
                ...
                "totals_low_pct": 38.8,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 30.9,
                "win_margin2_low_total_pct": 18.3,
                "win_margin2_high_total_pct": 38.8,
                "readout_cn": "Norway 已 1-0 领先：仍取胜约 84%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 61.2%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.5 球（公允参考约 2） · 外界总进球参考 2.5，高出模型约 0.5 球 · 外界参考略高于模型公允线（+0.5 球） · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2.5 个",
              "totals_high_pct": 46.2,
              "type_tags": [
                {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 20,
              "readout_cn": "Norway · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
        ...
        "public_summary_note": "【推演概要】Norway · 低位反击。 · 与模型 xG 对照：实力吻合 · 赛前净胜看法低于 xG 隐含约 1.25 · 部分达标净胜=1 约 25.9%（模型微调：主胜 +0% · 平 -1% · 客 +1%）",
        "preview_replay": {
          "actual_score": "1-4",
          "ht_score": null,
          "hits": [],
      ...
      "group_context": {
        ...
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Iraq 若取胜：积分 3，I 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Norway 若取胜：积分 6，客场抢分将改变 I 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 E 组：头名 Germany 3 分 · 次席 Côte d'Ivoire 同分（32强绑定组） · J 组：头名 Argentina 3 分 · 次席 Austria 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
    ...
    },
    {
        ...
        "stars": [
          {
            ...
            "stats": "3球 · MOTM",
            "rating": 9.5,
            "desc": "17'/60'/76' 帽子戏法 · 追平 Klose 16球"
          },
          {
        ...
        "injuries": [
          {
            "player": "Lionel Messi",
            "status": "FIT",
            "note": "17'/60'/76' 帽子戏法 · 追平 Klose 16球",
            "confirmed": true
          },
          {
            "player": "Emiliano Martínez",
            "status": "FIT",
            "note": "扑出 Chaibi 射门 · 零封",
            "confirmed": true
          }
        ],
        "rumors": [
      ...
      "depth_calibration": {
        ...
        "spread_cover": {
          ...
          "over_2_5_pct": 63.7,
          "over_3_pct": 40.3,
          "totals_lean_cn": "2.5 球参考偏多进球（约 63.7%）",
        ...
        "totals_analysis": {
          ...
          "index_note": "多/少进球两侧参考接近均衡",
          "totals_odds": null,
          "rational_cn": "模型略倾向多进球（总进球约 3 个 约 63.7%）；进球参考偏高且舆论更看好多进球场面",
          "score_link_cn": "小比分（1-0/1-1）偏少进球 · 2-0/2-1 居中 · 3 球+ 偏多进球"
        },
        "totals_line": 3,
        "applied_delta": {
        ...
        "display_summary": {
          "fav_name": "Argentina",
          "expected_total_goals": 2.98,
          "poisson_fav_win_pct": 80.5,
          "small_lead_pct": 22.2,
          "small_example_score": "1-0",
          ...
          "win_shape": {
            "fav_name": "Argentina",
            "note": "以下为模型在「该队取胜」假设下的路径分布，三项合计 100%。",
            "lead_cn": "取胜时以拉开·开放为主（拉开 · 开放 37.5%）",
            "shapes": [
              {
                "key": "narrow_low",
                "label": "险胜 · 控局",
          ...
          "excitement": {
            ...
            "label_key": "moderate",
            "label_color": "#C8A96E",
            "sub_cn": "预期首球等待约 28.2 分",
            "first_goal_wait": 28.2,
            "fast_pct": 65.5,
            "moderate_pct": 14.2,
            "slow_pct": 20.3,
            "tiers": [
          ...
          "xg_context": {
            ...
            "adjusted_home": 2.63,
            "adjusted_away": 0.56,
            "note": "基准 xG 2.8–0.6 → 调整后 2.63–0.56"
          },
          "calibration": {
            "signal_cn": "大众心理预期偏高",
            "signal_color": "#D95F6A",
            ...
            "summary_cn": "与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 0.75 · 模型认为仅小胜 1 球仍约 22.2% · 净胜≥3（全达标）约 34.5%"
          },
          "win_outlook": {
            "fav_name": "Argentina",
            "state_label": null,
            ...
            "margin_meet_pct": 34.5,
            "margin_half_pct": 0,
            "margin_fail_pct": 22.2,
            "margin_full_label": "净胜≥3",
            "margin_half_label": "走水净胜=2",
            "final_2_0_pct": null,
            "final_3_0_plus_pct": null,
            "margin_fail_note": "常见：仅赢 1 球（如 1-0、2-1）",
            "totals_line": 3,
            "totals_line_cn": "总进球约 3 个",
            "fair_totals_line": 2.75,
            "model_total_xg": 3.19,
            "totals_line_gap": 0.25,
            "totals_high_pct": 36.3,
            "totals_low_pct": 63.7,
            "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
            "win_low_total_pct": 26.4,
            "win_margin2_low_total_pct": 15,
            "win_margin2_high_total_pct": 30.2,
            "readout_cn": "取胜约 77%；若取胜，以「开放拉开」为主（37.5%）。 对着赛前净胜参考，净胜≥3（全达标）约 34.5%；对着外界总进球参考 总进球约 3 个，模型终场多于该参考的概率约 36.3%。 注意 2-0 类：净胜扩大但总进球仍可能低于外界参考。"
          },
          "totals_line": 3,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 3.0 球（公允参考约 2.75） · 外界总进球参考 3，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "Argentina · 净胜走向：达标与否难下定论",
            "sub_cn": "达标概率约 34.5% · 达标与否难下定论 进球氛围：几乎五五开",
            "spread": {
              "level": "uncertain",
              "label_cn": "净胜幅度难下定论",
              "color": "#8A96A8",
              ...
              "verdict_cn": "达标与否难下定论",
              "headline_cn": "Argentina · 净胜走向：达标与否难下定论",
              "pill_cn": "达标概率约 34.5% · 达标与否难下定论",
              "detail_cn": "Argentina · 赛前外界预期 净胜≥3。模型推演达标概率约 34.5%（仅胜 1 球约 22.2%）。",
              "extra_stats_cn": "仅胜 1 球约 22.2%",
              "full_cover_pct": 34.5,
              "half_cover_pct": 0,
              "lose1_pct": 22.2,
              "margin_full_label": "净胜≥3",
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": 10.8,
              "small_delta": 0.8,
              "narrative": "Argentina 先破门（已 1-0） → 「控节奏 · 保护 Messi」；Algeria 「Mahrez 单核」。领先后双方可能转入守势，比分差距不易再拉大。",
              "live_outlook": {
                "fav_name": "Argentina",
                ...
                "margin_line_cn": "Argentina · 赛前净胜参考 净胜≥3（全达标） · 走水净胜=2",
                "margin_meet_pct": 39.5,
                "margin_half_pct": 0,
                "margin_fail_pct": 23,
                "margin_full_label": "净胜≥3",
                "margin_half_label": "走水净胜=2",
                "final_2_0_pct": null,
                "final_3_0_plus_pct": 33.5,
                "margin_fail_note": "常见：仅赢 1 球（如 1-0、2-1）",
                "totals_line": 3,
                "totals_line_cn": "总进球约 3 个",
                "fair_totals_line": 2.25,
                ...
                "totals_high_pct": 32.1,
                "totals_low_pct": 67.9,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 35.7,
                "win_margin2_low_total_pct": 22.1,
                "win_margin2_high_total_pct": 28.8,
                "readout_cn": "Argentina 已 1-0 领先：仍取胜约 92.1%。 对着外界总进球参考 总进球约 3 个，模型终场多于该参考的概率约 32.1%。 常见收尾：2-0 约 22.1%（部分达标，非全达标）； 3-0+ 约 33.5%（对着 净胜≥3 全达标）。"
              }
            },
            {
              "side": "away",
              ...
              "excitement": {
                ...
                "label_key": "fast",
                "label_color": "#5BBF8A",
                "sub_cn": "预期首球等待约 26.6 分",
                "first_goal_wait": 26.6,
                "fast_pct": 60.3,
                "moderate_pct": 14.7,
                "slow_pct": 25,
                "tiers": [
              ...
              "big_delta": -25.4,
              "small_delta": 2.6,
              "narrative": "Algeria 先破门（已 0-1） → 「4-5-1 收缩」；Argentina 「堆前锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 3.0 球（公允参考约 2.75） · 外界总进球参考 3，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 3 个",
              "totals_high_pct": 36.3,
              "type_tags": [
                {
              ...
              "depth_label": "板凳深度偏高",
              "draw_trap_pct": 18,
              "readout_cn": "Argentina · 压制局 · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
        ...
        "public_summary_note": "【推演概要】Argentina · 压制局 · 低位反击。 · 与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 0.75 · 模型认为仅小胜 1 球仍约 22.2% · 净胜≥3（全达标）约 34.5%（模型微调：主胜 -4% · 平 +1% · 客 +3%）",
        "preview_replay": {
          "actual_score": "3-0",
          "ht_score": null,
          "hits": [
      ...
      "group_context": {
        ...
        "home": {
          ...
          "pts": 3,
          "played": 1,
          "if_1st": "32强 M86 · J 组第 1 vs H 组第 2 → 当前 H 组第 2倾向 Uruguay（强队）",
          "if_1st_r16": "16强 M95 · 对阵 D 组第 2 vs G 组第 2 之胜者",
          "if_1st_corridor": "阿根廷头名半区",
          "if_2nd": "32强 M84 · H 组第 1 vs J 组第 2 → 当前 H 组第 1倾向 Saudi Arabia",
        ...
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Argentina 若取胜：积分 6，J 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Algeria 若取胜：积分 3，客场抢分将改变 J 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 H 组：头名 Saudi Arabia 1 分 · 次席 Uruguay 同分（32强绑定组） · I 组：头名 Norway 3 分 · 次席 France 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
        "home_score": 3,
    ...
    },
    {
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 55%；若取胜，以「险胜收工」为主（45.2%）。 对着赛前净胜参考，净胜≥2（全达标）约 32.1%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 42.6%。 注意 2-0 类：净胜扩大但总进球仍可能低于外界参考。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.4 球（公允参考约 2.25） · 外界总进球参考 2.5，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "Austria · 净胜走向：达标与否难下定论",
            "sub_cn": "达标概率约 32.1% · 达标与否难下定论 进球氛围：几乎五五开",
            "spread": {
              "level": "uncertain",
              "label_cn": "净胜幅度难下定论",
              "color": "#8A96A8",
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": 24.9,
              "small_delta": 1.2,
              "narrative": "Austria 先破门（已 1-0） → 「继续压迫」；Jordan 「维持低位」。领先方继续进攻，仍有较大空间扩大比分。",
              "live_outlook": {
                "fav_name": "Austria",
                ...
                "model_total_xg": 1.97,
                "totals_line_gap": 0.25,
                "totals_high_pct": 58.4,
                "totals_low_pct": 41.6,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 33.6,
                "win_margin2_low_total_pct": 19.5,
                "win_margin2_high_total_pct": 37.4,
                "readout_cn": "Austria 已 1-0 领先：仍取胜约 84.7%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 58.4%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
              ...
              "big_delta": -18.9,
              "small_delta": -7.2,
              "narrative": "Jordan 先破门（已 0-1） → 「5-4-1 铁桶」；Austria 「更疯压迫」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.4 球（公允参考约 2.25） · 外界总进球参考 2.5，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2.5 个",
              "totals_high_pct": 42.6,
              "type_tags": [
                {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 24,
              "readout_cn": "Austria · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
        ...
        "public_summary_note": "【推演概要】Austria · 低位反击。 · 与模型 xG 对照：预期偏热 · 赛前净胜看法高于 xG 隐含约 0.75（模型微调：主胜 -3% · 平 +1% · 客 +2%）",
        "preview_replay": {
          "actual_score": "3-1",
          "ht_score": null,
          "hits": [
      ...
      "group_context": {
        ...
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Austria 若取胜：积分 6，J 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Jordan 若取胜：积分 3，客场抢分将改变 J 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 H 组：头名 Saudi Arabia 1 分 · 次席 Uruguay 同分（32强绑定组） · I 组：头名 Norway 3 分 · 次席 France 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测，不计入已确认推演权重。 · 全场 1-1 · FIFA/Sky：Neves 6' 头球破局 · Wissa 45+5' 历史性扳平 · 葡萄牙控球占优但终结欠佳",
        "predicted": {
          "formation": "4-3-3 / 4-2-3-1",
        ...
        "updated": "2026-06-18T22:00:00+08:00"
      },
      "home": {
        "name": "Portugal",
        "iso": "pt",
        ...
        "injuries": [
          {
            ...
            "status": "FIT",
            "note": "最后一届世界杯，K组揭幕预计首发",
            "confirmed": true
          },
          {
            "player": "Bruno Fernandes",
            "status": "FIT",
            "note": "曼联队长，B费 节拍器预计首发",
            "confirmed": true
          },
          {
            "player": "Rúben Dias",
      ...
      "referee": {
        "confirmed": true,
        "pending": false,
        "source": "FIFA · Match officials · 2026-06-17/18",
        ...
        "home_win_rate": 50,
        "bias_index": 49,
        "bias_note": "卡塔尔籍顶级裁判。C罗/葡萄牙控球局黄牌或偏少，但对刚果金低位铲抢与 Wissa 反击拉倒判罚果断。",
        "tendencies": [
        ...
        "factors": [
          {
            "tag": "实力差",
            "impact": "强",
            "detail": "xG 差 1.4+，C罗/B费 决定比分"
          },
          {
            "tag": "反击",
            "impact": "中",
            "detail": "Wissa 速度是刚果金唯一威胁"
          },
          {
            "tag": "深度",
            "impact": "强",
      ...
      "coach_analysis": {
        "home": {
          ...
          "match_note": "K 组揭幕必须开门红——C罗/B费 肋部+Leão 宽度；2–0 后 65' 轮换。"
        },
        "away": {
          ...
          "match_note": "4-5-1 低位+Wissa 转换；守 0–2 可接受，0–1 进入 70' 即是胜利。"
        }
      },
      "weather": {
        "city": "休斯顿",
        ...
        "weather_factors": [
          {
            "label": "32°C · 12:00 CT 开球",
            "impact": "中性偏利控球",
            "detail": "北京时间 01:00 对应休斯顿正午前段，湿热峰值；葡萄牙 90 分钟控球消耗需轮换计划"
          },
          {
            "label": "封闭式球场",
            "impact": "略降体能消耗",
            "detail": "无直射阳光但湿度 68% 仍高；对刚果金低位防守专注度是考验"
          },
          {
            "label": "海平面 15m",
            "impact": "无海拔差",
      ...
      "mystic": {
        "date_bazi": {
          ...
          "day_element": "土+水",
          "day_dominant": "土",
          "day_summary": "戊子日——戊土坐子，土水相激。《道德经》曰：「知人者智，自知者明。」子水当令，宜守中蓄势；忌土性固执。非力之大小，乃气之顺逆。",
          "hour_home": "丑时（01:00-03:00）",
          "hour_home_element": "土"
        },
        "wuxing": {
          "home": {
            ...
            "verdict_color": "#5BBF8A",
            "compat": 68,
            "reason": "红属火、绿属木。戊子日土水相激，丑时土稳火——火木相生如「木火通明」，《说卦》离为火，主队服色与丑时同频。",
            "advantage": "丑土稳火，顺时而聚"
          },
          "away": {
            "team": "Congo DR",
            ...
            "verdict_color": "#C8A96E",
            "compat": 42,
            "reason": "红黄蓝三色相杂，子水当令下火性易散——如「火在水上」，宜守不宜攻。",
            "disadvantage": "气运未齐，转换需待时"
          },
        ...
        "hexagram": {
          ...
          "advantage_team": "Portugal",
          "disadvantage_team": "Congo DR",
          "hexagram_analysis": "晋卦「康侯用锡马蕃庶」：离火在下上升，如丑时土中藏火渐明。前半程宜亮局；坤地承火，后段气运再动。",
          "match_nature": "明出地上 · 顺火者晋",
          "yellow_card_risk": "中",
          ...
          "scenarios": [
            {
              "icon": "☯",
              "label": "气运性质",
              "text": "火木相生，顺丑时土气者先明后稳"
            },
            {
              "icon": "⏱",
              "label": "进球高峰段",
              "text": "第 18-32 分钟（晋卦「明出地上」）及第 62-78 分钟（坤地承火、丑土后段助火）"
            },
            {
              "icon": "🟨",
              "label": "纪律",
          ...
          "early_goal": {
            "scenario": "若葡萄牙先进球",
            "prediction": "晋象全现——火地相生，追加进球窗口在 20-35 分钟；忌「明出」后躁进触未济。",
            "favors": "Portugal",
            "favors_prob": 62
          },
          "no_early_goal": {
            "scenario": "若前 30 分钟无进球",
            "prediction": "丑土主静，气运蓄势；第 32-45 分钟子水渐移，先破局者占「明出」之势。",
            "favors": "Portugal",
            "favors_prob": 55
          },
          "away_goal": {
            "scenario": "若刚果金偷袭破门",
            "prediction": "晋遭逆——坎水暗流；主队需以火木相生耐心反扑，65 分钟后土气助火。",
            "favors": "Portugal",
            "favors_prob": 52
          }
        },
          ...
          "windows": [
            {
              ...
              "start_min": 18,
              "end_min": 32,
              "hex_reason": "晋卦「明出地上」，离火渐明",
              "time_reason": "丑时土中藏火，气由静转明"
            },
            {
              "label": "下半场",
              "half": "second",
              "start_min": 62,
              "end_min": 78,
              "hex_reason": "坤地承火，后段气泄再动",
              "time_reason": "丑时后段土旺助火"
            }
          ],
          "periods": "第 18-32 分钟 · 第 62-78 分钟",
          "rationale": "戊子日土水相激，丑时土气稳火；晋卦明示「明出地上」——上半场离火渐明为首次气运窗口，坤地承火、丑土后段助火为第二次。上下两段皆有卦象依据，故示双窗。",
          "note": "娱乐解读 · 纯玄学参考 · 非赛程或竞技推演",
          "logic_hint": "依赛日八字、开球时辰、卦象与五行生克推断；卦象只示一段气运则只给一段，不凑数。"
        },
        "home_score": 78,
        "away_score": 34,
        "mystic_verdict": "葡萄牙火木相生，刚果金气运未齐——顺丑时土火者先明后稳。",
        "model_bridge": "xG 2.15-0.72 碾压，Wissa 反击是唯一变数。",
        "disclaimer": "以上分析援引《道德经》《周易》五行学说，纯属道家文化解读，仅供文化参考，不构成竞技或决策依据"
      },
      "depth_calibration": {
        "tier_home": 1.75,
        ...
        "totals_analysis": {
          ...
          "totals_odds": null,
          "rational_cn": "模型在 总进球约 2.5–3 个 附近均衡；进球参考偏高且舆论更看好多进球场面",
          "score_link_cn": "小比分（1-0/1-1）偏少进球 · 2-0/2-1 居中 · 3 球+ 偏多进球"
        },
        "totals_line": 2.75,
        "applied_delta": {
        ...
        "display_summary": {
          ...
          "context_factors": [
            ...
            },
            {
              "icon": "👔",
              "label": "教练风格",
              "note": "控节奏 · 保护 C罗 / 5-4-1 收缩（领先时）"
            },
            {
              "icon": "🌤️",
              "label": "气候",
              "note": "湿热变量中等——C罗/B费 控球深度略受益，Wissa 冲刺型打法对气温不敏感"
            }
          ],
          "xg_context": {
            "baseline_home": 2.15,
            ...
            "adjusted_home": 2.02,
            "adjusted_away": 0.68,
            "note": "基准 xG 2.15–0.72 → 调整后 2.02–0.68"
          },
          "calibration": {
            "signal_cn": "大众心理预期偏高",
            "signal_color": "#D95F6A",
            ...
            "summary_cn": "与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 1 · 部分达标净胜=1 约 25.7%"
          },
          "win_outlook": {
            "fav_name": "Portugal",
            "state_label": null,
            ...
            "model_total_xg": 2.7,
            "totals_line_gap": 0.75,
            "totals_high_pct": 38.5,
            "totals_low_pct": 61.5,
            "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
            "win_low_total_pct": 27.8,
            "win_margin2_low_total_pct": 14,
            "win_margin2_high_total_pct": 28.6,
            "readout_cn": "取胜约 65%；若取胜，以「险胜收工」为主（37.7%）。 对着赛前净胜参考，净胜≥2（全达标）约 42.6%；部分达标净胜=1 约 25.7%；对着外界总进球参考 总进球约 2.5–3 个，模型终场多于该参考的概率约 38.5%。 注意 2-0 类：净胜扩大但总进球仍可能低于外界参考。"
          },
          "totals_line": 2.75,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.6 球（公允参考约 2） · 外界总进球参考 2.75，高出模型约 0.75 球 · 外界参考略高于模型公允线（+0.75 球） · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "Portugal · 净胜走向：有达标可能",
            "sub_cn": "达标概率约 42.6% · 有达标可能 进球氛围：几乎五五开",
            "spread": {
              "level": "possible",
              "label_cn": "有达标可能",
              "color": "#C8A96E",
              ...
              "verdict_cn": "有达标可能",
              "headline_cn": "Portugal · 净胜走向：有达标可能",
              "pill_cn": "达标概率约 42.6% · 有达标可能",
              "detail_cn": "Portugal · 赛前外界预期 净胜≥2。模型推演达标概率约 42.6%；有一定达标空间，但非高把握（部分达标净胜=1 约 25.7%）。",
              "extra_stats_cn": "部分达标净胜=1 约 25.7%",
              "full_cover_pct": 42.6,
              "half_cover_pct": 25.7,
              "lose1_pct": 0,
              "margin_full_label": "净胜≥2",
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": 14.2,
              "small_delta": 4.2,
              "narrative": "Portugal 先破门（已 1-0） → 「控节奏 · 保护 C罗」；Congo DR 「Wissa 单核」。领先后双方可能转入守势，比分差距不易再拉大。",
              "live_outlook": {
                "fav_name": "Portugal",
                ...
                "totals_low_pct": 62.2,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 40.9,
                "win_margin2_low_total_pct": 22.8,
                "win_margin2_high_total_pct": 34.1,
                "readout_cn": "Portugal 已 1-0 领先：仍取胜约 86.7%。 对着外界总进球参考 总进球约 2.5–3 个，模型终场多于该参考的概率约 37.8%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
              ...
              "big_delta": -22.4,
              "small_delta": -3.2,
              "narrative": "Congo DR 先破门（已 0-1） → 「5-4-1 收缩」；Portugal 「堆边锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.6 球（公允参考约 2） · 外界总进球参考 2.75，高出模型约 0.75 球 · 外界参考略高于模型公允线（+0.75 球） · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2.5–3 个",
              "totals_high_pct": 38.5,
              "type_tags": [
                {
              ...
              "depth_label": "板凳深度偏高",
              "draw_trap_pct": 16,
              "readout_cn": "Portugal · 压制局 · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
            "draw_trap_note": "平局风险：低位反击队若先进球或被追平，1-1 / 0-0 比客胜更现实（约 16% 冷门空间含平局）。",
            "archetype": {
              "tags": [
                {
                  "key": "dominance",
        ...
        "public_summary_note": "【推演概要】Portugal · 压制局 · 低位反击。 · 与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 1 · 部分达标净胜=1 约 25.7%（模型微调：主胜 -5% · 平 +1% · 客 +4%）",
        "preview_replay": {
          "actual_score": "1-1",
          "ht_score": "1-1",
          "hits": [
      ...
      "group_context": {
        ...
        "scenarios": [
          ...
          "平局：双方各 +1 分；在 L 组：头名 England 3 分 · 次席 Ghana 同分（32强绑定组） · J 组：头名 Argentina 3 分 · 次席 Austria 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
        "home_score": 1,
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测，不计入已确认推演权重。 · 全场 4-2 · ESPN：凯恩 12'(点)+42' · 克罗地亚 Baturina 36'、Musa 45+5' 扳平后英格兰再进两球",
        "predicted": {
          "formation": "4-2-3-1 / 4-3-3",
      ...
      "referee": {
        ...
        "home_win_rate": 48,
        "bias_index": 50,
        "bias_note": "2022 决赛主裁，大赛尺度成熟。英格兰 vs 克罗地亚 2018 半决赛重演，对 Modrić/Bellingham 犯规判罚是焦点。",
        "tendencies": [
        ...
        "factors": [
          {
            "tag": "历史",
            "impact": "强",
            "detail": "2018 半决赛克罗地亚胜是心理资产"
          },
          {
            "tag": "中场",
            "impact": "强",
            "detail": "Modrić vs Bellingham 决定节奏"
          },
          {
            "tag": "心理",
            "impact": "中",
            "detail": "英格兰大赛压力 vs 克罗地亚大赛 DNA"
          }
        ]
      },
      "coach_analysis": {
        "home": {
          ...
          "match_note": "2018 半决赛重演——Bellingham 伪 10 + Saka 宽度；Modrić 75' 可能换下。"
        },
        "away": {
          "name": "Zlatko Dalić",
          "age": 58,
          ...
          "subs": {
            "timing": "首换 65–70 分钟",
            "pattern": "Modrić 常 75' 换下",
            "avg_first_sub": "68'",
            "note": "大赛经验顶级"
          },
          "when_leading": {
            "label": "4-5-1 收缩",
            "detail": "若意外领先：退守+Modrić 控节奏。"
          },
          "when_trailing": {
            "label": "堆中场",
          ...
          "match_note": "4-5-1 低位+Modrić 直塞；2018 胜英格兰是心理资产，守 0–1 可接受。"
        }
      },
      "weather": {
        "city": "达拉斯",
        ...
        "weather_factors": [
          {
            "label": "34°C · 16:00 CT 开球",
            "impact": "不利老化中场",
            "detail": "北京时间 04:00 对应达拉斯午后最热时段；Modrić 75' 换下概率上升"
          },
          {
            "label": "封闭式球场",
            "impact": "略降直射",
            "detail": "无屋顶但空调系统；对双方影响相当"
          }
        ],
      ...
      "mystic": {
        ...
        "wuxing": {
          "home": {
            ...
            "verdict_color": "#C8A96E",
            "compat": 56,
            "reason": "白属金、红属火。寅时木气初升，金火相涵——如「火在天上」，宜稳不宜急。",
            "advantage": "寅木泄火，控节奏则吉"
          },
          "away": {
            "team": "Croatia",
            "colors": "红+白+蓝",
            ...
            "verdict_color": "#C8A96E",
            "compat": 54,
            "reason": "红白蓝三色，水火既济。坎水如老泉深流，大赛气运偏守后动。",
            "advantage": "水气在后，后段渐盛"
          },
        ...
        "hexagram": {
          ...
          "advantage_team": "England",
          "disadvantage_team": "Croatia",
          "hexagram_analysis": "既济「水在火上，初吉终乱」：寅时木泄火气，上半场宜试探守中；坎水在后，后段水气渐盛，气运由静转乱。",
          "match_nature": "初吉终乱 · 胶着局",
          "yellow_card_risk": "中",
          ...
          "scenarios": [
            {
              "icon": "☯",
              "label": "气运性质",
              "text": "寅时木气，双方守中待发——气运近而不齐"
            },
            {
              "icon": "⏱",
              "label": "进球高峰段",
              "text": "第 22-38 分钟（寅木动、初吉段气开）及第 72-88 分钟（坎水当令、终乱段气转）"
            },
            {
              "icon": "🟨",
              "label": "纪律",
              "text": "既济主慎，黄牌来自 tactical 阻截"
            }
          ],
          "early_goal": {
            "scenario": "若英格兰先进球",
            "prediction": "既济「初吉」——领先方忌躁进；坎水在后，75' 后气运变数升。",
            "favors": "England",
            "favors_prob": 54
          },
          "no_early_goal": {
            "scenario": "若前 35 分钟无进球",
            "prediction": "寅木主静，0-0 符合卦象；下半场 40-55 分钟为第一次破局窗口。",
            "favors": "Draw",
            "favors_prob": 48
          },
          "away_goal": {
            "scenario": "若克罗地亚先进球",
            "prediction": "既济逆象——水气复萌；英格兰金火需耐心，60-75 分钟反扑窗口。",
            "favors": "Croatia",
            "favors_prob": 52
          }
        },
          ...
          "windows": [
            {
              ...
              "start_min": 22,
              "end_min": 38,
              "hex_reason": "既济「初吉」，离火试探后气开",
              "time_reason": "寅时木气初动，动而后生气运易涌"
            },
            {
              "label": "下半场",
              "half": "second",
              "start_min": 72,
              "end_min": 88,
              "hex_reason": "既济「终乱」，坎水当令",
              "time_reason": "后段水气渐盛，气运由静转乱"
            }
          ],
          "periods": "第 22-38 分钟 · 第 72-88 分钟",
          "rationale": "寅时木气初动，戊子日宜守中；既济卦「初吉终乱」明示前后两段气运——初吉段试探后气开，终乱段坎水当令。卦象双段清晰，故示上下双窗。",
          "note": "娱乐解读 · 纯玄学参考 · 非赛程或竞技推演",
          "logic_hint": "依赛日八字、开球时辰、卦象与五行生克推断；卦象只示一段气运则只给一段，不凑数。"
        },
        "home_score": 64,
        "away_score": 50,
        "mystic_verdict": "英格兰金火相涵，克罗地亚水火既济——气运相近，平局空间不可低估。",
        "model_bridge": "xG 1.62-1.18 略优英格兰，2018 半决赛心理是变量。",
        "disclaimer": "以上分析援引《道德经》《周易》五行学说，纯属道家文化解读，仅供文化参考，不构成竞技或决策依据"
      },
      "depth_calibration": {
        "tier_home": 0.5,
        ...
        "display_summary": {
          ...
          "poisson_fav_win_pct": 46.7,
          "small_lead_pct": 24.5,
          "small_example_score": "1-0",
          "small_example_pct": 13.5,
          "big_cover_pct": 22.2,
          "big_example_score": "2-0",
          "big_example_pct": 9.3,
          "win_shape": {
            "fav_name": "England",
            "note": "以下为模型在「该队取胜」假设下的路径分布，三项合计 100%。",
            "lead_cn": "取胜时以拉开·控局为主（拉开 · 控局 29.1%）",
            "shapes": [
              {
                "key": "narrow_low",
                "label": "险胜 · 控局",
          ...
          "context_factors": [
            {
              "icon": "🏥",
              "label": "伤病",
              "note": "England：John Stones 存疑 · Croatia：Bruno Petković 缺阵"
            },
            {
              "icon": "👔",
              "label": "教练风格",
            ...
            },
            {
              "icon": "🌤️",
              "label": "气候",
              "note": "炎热变量中等——Bellingham 年轻体能略优，克罗地亚后段慢热需防"
            }
          ],
          "xg_context": {
            "baseline_home": 1.62,
            ...
            "adjusted_home": 1.38,
            "adjusted_away": 0.95,
            "note": "基准 xG 1.62–1.18 → 调整后 1.38–0.95"
          },
          "calibration": {
            "signal_cn": "实力吻合",
            "signal_color": "#5BBF8A",
          ...
          "win_outlook": {
            ...
            "win_margin2_high_total_pct": 12.9,
            "readout_cn": "取胜约 49%；若取胜，以「险胜收工」为主（52.4%）。 对着赛前净胜参考，净胜≥1（全达标）约 46.7%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 41%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.3 球（公允参考约 2.25） · 外界总进球参考 2.5，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "England · 净胜走向：有达标可能",
            "sub_cn": "达标概率约 46.7% · 有达标可能 进球氛围：几乎五五开",
            "spread": {
              "level": "possible",
              "label_cn": "有达标可能",
              "color": "#C8A96E",
              ...
              "verdict_cn": "有达标可能",
              "headline_cn": "England · 净胜走向：有达标可能",
              "pill_cn": "达标概率约 46.7% · 有达标可能",
              "detail_cn": "England · 赛前外界预期 净胜≥1。模型推演达标概率约 46.7%；有一定达标空间，但非高把握。",
              "extra_stats_cn": "",
              "full_cover_pct": 46.7,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": 14.6,
              "small_delta": 10.2,
              "narrative": "England 先破门（已 1-0） → 「控节奏 · 适度轮换」；Croatia 「堆中场」。领先方继续进攻，仍有较大空间扩大比分。",
              "live_outlook": {
                "fav_name": "England",
                ...
                "margin_line_cn": "England · 赛前净胜参考 净胜≥1（全达标）",
                "margin_meet_pct": 71.5,
                "margin_half_pct": 0,
                "margin_fail_pct": 34.7,
                "margin_full_label": "净胜≥1",
                "margin_half_label": null,
                "final_2_0_pct": null,
                "final_3_0_plus_pct": null,
                ...
                "totals_low_pct": 51.2,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 36.8,
                "win_margin2_low_total_pct": 17.3,
                "win_margin2_high_total_pct": 19.5,
                "readout_cn": "England 已 1-0 领先：仍取胜约 71.5%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 48.8%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
              ...
              "big_delta": -14.1,
              "small_delta": -9.3,
              "narrative": "Croatia 先破门（已 0-1） → 「4-5-1 收缩」；England 「堆前锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.3 球（公允参考约 2.25） · 外界总进球参考 2.5，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2.5 个",
              "totals_high_pct": 41,
              "type_tags": [
                {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 32,
              "readout_cn": "England · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测，不计入已确认推演权重。 · 全场 1-0 · ABC/ESPN：全场沉闷至补时 · Yirenkyi 90+4' 门前混战破门",
        "predicted": {
          "formation": "4-2-3-1 / 4-4-2",
      ...
      "referee": {
        ...
        "home_win_rate": 49,
        "bias_index": 49,
        "bias_note": "瑞典籍主裁。Kudus/Partey 对位巴拿马 MLS 班底，对身体对抗容忍度中等；定位球犯规尺度是变量。",
        "tendencies": [
        ...
        "factors": [
          {
            "tag": "实力差",
            "impact": "强",
            "detail": "xG 差 0.7+，Kudus 终结效率决定比分"
          },
          {
            "tag": "定位球",
            "impact": "中",
            "detail": "Fajardo 头球 vs 加纳防空"
          },
          {
            "tag": "慢热",
            "impact": "中",
      ...
      "coach_analysis": {
        "home": {
          ...
          "subs": {
            "timing": "首换 60–65 分钟",
            "pattern": "常换 Semenyo/J. Ayew",
            "avg_first_sub": "62'",
            "note": "换人合理"
          },
          "when_leading": {
            "label": "4-5-1 收缩",
            "detail": "1 球领先：退守+Kudus 反击。"
          },
          "when_trailing": {
            "label": "堆边锋",
          ...
          "match_note": "Kudus/Partey 对位巴拿马 MLS 班底；首战 3 分不容有失。"
        },
        "away": {
          ...
          "match_note": "4-4-2 低位+Fajardo 定位球偷分；60' 后体能是最大考验。"
        }
      },
      "weather": {
        "city": "多伦多",
        ...
        "weather_factors": [
          {
            "label": "22°C · 19:00 ET 傍晚",
            "impact": "有利高强度",
            "detail": "北京时间 07:00 对应多伦多最舒适时段"
          },
          {
            "label": "天然草皮",
            "impact": "略利传控方",
            "detail": "Kudus 边路突破落点稳定"
          }
        ],
      ...
      "mystic": {
        ...
        "wuxing": {
          "home": {
            ...
            "verdict_color": "#C8A96E",
            "compat": 55,
            "reason": "红黄绿三色，辰时土气当令。土火相杂，木可破土——宜正合破局。",
            "advantage": "辰土稳阵，木火破土"
          },
          "away": {
            "team": "Panama",
            ...
            "wuxing_short": "金水相生",
            "verdict": "不利",
            "verdict_color": "#E85D5D",
            "compat": 38,
            "reason": "金水相生但戊子日土水相激，水气被土克——如「泽无水」，守势难久。",
            "disadvantage": "气运偏逆，险地偶可惊雷"
          },
        ...
        "hexagram": {
          ...
          "advantage_team": "Ghana",
          "disadvantage_team": "Panama",
          "hexagram_analysis": "师卦「地中有水」：辰时土旺，正合之气集中一段；坎水伏地，卦未明示后段第二高峰。",
          "match_nature": "以正合 · 主队渐优",
          "yellow_card_risk": "低至中",
          ...
          "scenarios": [
            ...
            },
            {
              "icon": "⏱",
              "label": "进球高峰段",
              "text": "第 25-42 分钟（辰土稳阵后气运破土——师卦只示此一段）"
            },
            {
              "icon": "🟨",
              "label": "纪律",
          ...
          "early_goal": {
            "scenario": "若加纳先进球",
            "prediction": "师象全现——辰土助火，追加窗口在 30-45 分钟。",
            "favors": "Ghana",
            "favors_prob": 58
          },
          "no_early_goal": {
            "scenario": "若前 30 分钟无进球",
            "prediction": "师卦宜「贞」——守正待机，35-50 分钟为破局段。",
            "favors": "Ghana",
            "favors_prob": 52
          },
          "away_goal": {
            "scenario": "若巴拿马险地破门",
            "prediction": "师遭逆——地水险地；加纳需以土火正合反扑，60' 后气运回。",
            "favors": "Ghana",
            "favors_prob": 50
          }
        },
          ...
          "windows": [
            {
              ...
              "start_min": 25,
              "end_min": 42,
              "hex_reason": "师卦「以正合」，地中有水、稳后破土",
              "time_reason": "辰时土气当令，气运集中一段"
            }
          ],
          "periods": "第 25-42 分钟",
          "rationale": "辰时土气当令，师卦主「贞」与正合——气运集中於土稳后破土一段，卦象未明示下半场第二高峰。宁缺毋滥，只示上半场一窗。",
          "note": "娱乐解读 · 纯玄学参考 · 非赛程或竞技推演",
          "logic_hint": "依赛日八字、开球时辰、卦象与五行生克推断；卦象只示一段气运则只给一段，不凑数。"
        },
        "home_score": 63,
        "away_score": 28,
        "mystic_verdict": "加纳土火相杂，巴拿马气运偏逆——辰土正合，先动气运者占「丈人吉」。",
        "model_bridge": "xG 1.55-0.82 占优，加纳大赛慢热需防。",
        "disclaimer": "以上分析援引《道德经》《周易》五行学说，纯属道家文化解读，仅供文化参考，不构成竞技或决策依据"
      },
      "depth_calibration": {
        "tier_home": 1,
        ...
        "spread_cover": {
          ...
          "over_2_5_pct": 41.9,
          "over_3_pct": 21.1,
          "totals_lean_cn": "2.5 球参考偏少进球（约 58.1%）；3 球参考偏少",
        ...
        "totals_analysis": {
          ...
          "index_note": "少进球侧参考权重相对更高",
          "totals_odds": null,
          "rational_cn": "模型略倾向少进球（总进球约 2–2.5 个 约 58.1%）",
          "score_link_cn": "小比分（1-0/1-1）偏少进球 · 2-0/2-1 居中 · 3 球+ 偏多进球"
        },
        "totals_line": 2.25,
        "applied_delta": {
        ...
        "display_summary": {
          "fav_name": "Ghana",
          "expected_total_goals": 2.31,
          "poisson_fav_win_pct": 55.1,
          "small_lead_pct": 26.3,
          "small_example_score": "1-0",
          "small_example_pct": 15,
          "big_cover_pct": 28.9,
          "big_example_score": "2-0",
          ...
          "context_factors": [
            {
              "icon": "🏥",
              "label": "伤病",
              "note": "Ghana 暂无重要伤停 · Panama：Adalberto Carrasquilla 存疑"
            },
            {
              "icon": "👔",
              "label": "教练风格",
            ...
            },
            {
              "icon": "🌤️",
              "label": "气候",
              "note": "气候均衡——Kudus/Partey 对位巴拿马是推演核心，天气不构成冷门变量"
            }
          ],
          "xg_context": {
            "baseline_home": 1.55,
            ...
            "adjusted_home": 1.55,
            "adjusted_away": 0.79,
            "note": "基准 xG 1.55–0.82 → 调整后 1.55–0.79"
          },
          "calibration": {
            "signal_cn": "大众心理预期偏高",
            "signal_color": "#D95F6A",
          ...
          "win_outlook": {
            ...
            "totals_low_pct": 45.6,
            "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
            "win_low_total_pct": 26.6,
            "win_margin2_low_total_pct": 11.6,
            "win_margin2_high_total_pct": 28.9,
            "readout_cn": "取胜约 50%；若取胜，以「险胜收工」为主（47.6%）。 对着赛前净胜参考，净胜≥2（全达标）约 28.9%；对着外界总进球参考 总进球约 2–2.5 个，模型终场多于该参考的概率约 54.4%。"
          },
          "totals_line": 2.25,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.3 球（公允参考约 2.25） · 外界总进球参考 2.25 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "Ghana · 净胜走向：达到预期难度偏大",
            "sub_cn": "达标概率约 28.9% · 达到预期难度偏大 进球氛围：几乎五五开",
            "spread": {
              "level": "skeptical",
              "label_cn": "外界预期偏高",
              "color": "#D95F6A",
              ...
              "detail_cn": "Ghana · 赛前外界预期 净胜≥2。模型推演达标概率约 28.9%；外界看法高于 xG 隐含约 0.75 球，达到预期难度偏大。",
              "extra_stats_cn": "",
              "full_cover_pct": 28.9,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": 16.5,
              "small_delta": 9.2,
              "narrative": "Ghana 先破门（已 1-0） → 「4-5-1 收缩」；Panama 「维持低位」。领先后双方可能转入守势，比分差距不易再拉大。",
              "live_outlook": {
                "fav_name": "Ghana",
                ...
                "margin_line_cn": "Ghana · 赛前净胜参考 净胜≥2（全达标） · 走水净胜=1",
                "margin_meet_pct": 45.4,
                "margin_half_pct": 0,
                "margin_fail_pct": 35.5,
                "margin_full_label": "净胜≥2",
                "margin_half_label": "走水净胜=1",
                "final_2_0_pct": null,
                "final_3_0_plus_pct": null,
                ...
                "totals_low_pct": 39.5,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 44.6,
                "win_margin2_low_total_pct": 21.9,
                "win_margin2_high_total_pct": 45.4,
                "readout_cn": "Ghana 已 1-0 领先：仍取胜约 80.9%。 对着外界总进球参考 总进球约 2–2.5 个，模型终场多于该参考的概率约 60.5%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
              ...
              "big_delta": -17.5,
              "small_delta": -8.2,
              "narrative": "Panama 先破门（已 0-1） → 「5-4-1 铁桶」；Ghana 「堆边锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.3 球（公允参考约 2.25） · 外界总进球参考 2.25 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2–2.5 个",
              "totals_high_pct": 54.4,
              "type_tags": [
                {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 22,
              "readout_cn": "Ghana · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
        ...
        "public_summary_note": "【推演概要】Ghana · 低位反击。 · 与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 0.75（模型微调：主胜 -4% · 平 +1% · 客 +3%）",
        "preview_replay": {
          "actual_score": "1-0",
          "ht_score": "0-0",
          "hits": [
      ...
      "group_context": {
        ...
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Ghana 若取胜：积分 6，L 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Panama 若取胜：积分 3，客场抢分将改变 L 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 K 组：头名 Colombia 3 分 · 次席 Portugal 1 分（32强绑定组） · A 组：头名 Mexico 6 分 · 次席 South Korea 3 分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测，不计入已确认推演权重。 · 全场 1-3 · FIFA：Muñoz 41' 转身破门 · Shomurodov 射门被 Vargas 扑出 Fayzullaev 补射 · Díaz 65' 再领先",
        "predicted": {
          "formation": "4-2-3-1 / 4-2-3-1",
      ...
      "referee": {
        ...
        "home_win_rate": 51,
        "bias_index": 51,
        "bias_note": "英格兰籍顶级裁判。Azteca 高原夜战，对 Díaz/James 速度局禁区内拉扯判罚尺度是核心变量。",
        "tendencies": [
        ...
        "factors": [
          {
            "tag": "实力差",
            "impact": "强",
            "detail": "xG 差 0.9+，Díaz 终结效率决定比分"
          },
          {
            "tag": "高原",
            "impact": "中",
            "detail": "2240m 海拔略利主队，哥伦比亚后段体能是变量"
          },
          {
            "tag": "反击",
            "impact": "中",
            "detail": "Shomurodov 速度是乌兹别克唯一威胁"
          }
        ]
      },
      "coach_analysis": {
        "home": {
          ...
          "vs_strong": {
            "label": "对强队：龟缩+高原",
            "detail": "对哥伦比亚：低位+Shomurodov 速度。"
          },
          "vs_weak": {
            "label": "不适用",
            "detail": "K 组无弱于乌兹别克的对手。"
          },
          ...
          "match_note": "Azteca 高原+Shomurodov 反击；守 0–1 求 1 分是现实目标。"
        },
        "away": {
          "name": "Néstor Lorenzo",
          "age": 58,
          ...
          "match_note": "Díaz/James 宽度——高原夜战宜早破局，对低位需耐心。"
        }
      },
      "weather": {
        "city": "墨西哥城",
        ...
        "weather_factors": [
          {
            "label": "2240m 海拔",
            "impact": "利主队适应",
            "detail": "氧气稀薄对客队后段体能影响约 8–12%；哥伦比亚 60' 后宽度可能下降"
          },
          {
            "label": "24°C · 21:00 CT 晚场",
            "impact": "中性",
            "detail": "晚场温度舒适，但海拔因素仍主导"
          },
          {
            "label": "降雨概率 35%",
            "impact": "传球微调",
            "detail": "若小雨，Díaz 内切射门略利"
          }
        ],
      ...
      "mystic": {
        ...
        "wuxing": {
          ...
          "away": {
            ...
            "verdict_color": "#5BBF8A",
            "compat": 66,
            "reason": "巳时火气当令，火土相生如「火在天上」——顺天时者元亨。",
            "advantage": "巳火助火土，宜早顺天"
          },
        ...
        "hexagram": {
          ...
          "advantage_team": "Colombia",
          "disadvantage_team": "Uzbekistan",
          "hexagram_analysis": "大有「自天佑之」：巳火当令，离火在天，气运一处独旺；卦象未示后段再动第二高峰。",
          "match_nature": "火在天上 · 客队顺时",
          "yellow_card_risk": "低",
          ...
          "scenarios": [
            ...
            },
            {
              "icon": "⏱",
              "label": "进球高峰段",
              "text": "第 15-30 分钟（大有「火在天上」、巳火初盛——卦只示此一段）"
            },
            {
              "icon": "🟨",
              "label": "纪律",
          ...
          "early_goal": {
            "scenario": "若哥伦比亚先进球",
            "prediction": "大有元亨——追加窗口在 25-40 分钟；忌轻敌触「亢龙有悔」。",
            "favors": "Colombia",
            "favors_prob": 65
          },
          "no_early_goal": {
            "scenario": "若前 25 分钟无进球",
            "prediction": "守中延局；30-45 分钟巳火仍旺，破局概率升。",
            "favors": "Colombia",
            "favors_prob": 58
          },
          "away_goal": {
            "scenario": "若乌兹别克偷袭破门",
            "prediction": "大有遭逆——地气上升偶可惊雷；客队需火天相生反扑，55' 前宜破局。",
            "favors": "Colombia",
            "favors_prob": 56
          }
        },
          ...
          "windows": [
            {
              ...
              "start_min": 15,
              "end_min": 30,
              "hex_reason": "大有「火在天上」，元亨气一处独旺",
              "time_reason": "巳时火气当令，离火初盛"
            }
          ],
          "periods": "第 15-30 分钟",
          "rationale": "巳时火气当令，大有卦「火在天上、元亨」——气运集中於开场离火渐盛一段，卦未明示后段第二高峰。宁缺毋滥，只示上半场一窗。",
          "note": "娱乐解读 · 纯玄学参考 · 非赛程或竞技推演",
          "logic_hint": "依赛日八字、开球时辰、卦象与五行生克推断；卦象只示一段气运则只给一段，不凑数。"
        },
        "home_score": 48,
        "away_score": 76,
        "mystic_verdict": "哥伦比亚火土相生，乌兹别克金水守中——巳火顺天者元亨。",
        "model_bridge": "xG 0.88-1.78 哥伦比亚碾压，海拔是乌兹别克唯一隐性优势。",
        "disclaimer": "以上分析援引《道德经》《周易》五行学说，纯属道家文化解读，仅供文化参考，不构成竞技或决策依据"
      },
      "depth_calibration": {
        "tier_home": -1.25,
        ...
        "display_summary": {
          ...
          "win_shape": {
            "fav_name": "Colombia",
            "note": "以下为模型在「该队取胜」假设下的路径分布，三项合计 100%。",
            "lead_cn": "取胜时以拉开·控局为主（拉开 · 控局 32.7%）",
            "shapes": [
              {
                "key": "narrow_low",
                "label": "险胜 · 控局",
          ...
          "context_factors": [
            ...
            },
            {
              "icon": "👔",
              "label": "教练风格",
              "note": "5-4-1 铁桶 / 控节奏 · 宽度（领先时）"
            },
            {
              "icon": "🌤️",
              "label": "气候",
              "note": "高原变量高——Shomurodov 主队适应 vs Díaz 年轻体能，后段 xG 分布可能偏移"
            }
          ],
          "xg_context": {
            "baseline_home": 0.88,
            ...
            "adjusted_home": 0.74,
            "adjusted_away": 1.5,
            "note": "基准 xG 0.88–1.78 → 调整后 0.74–1.5"
          },
          "calibration": {
            "signal_cn": "实力吻合",
            "signal_color": "#5BBF8A",
            ...
            "summary_cn": "与模型 xG 对照：实力吻合 · 赛前净胜看法低于 xG 隐含约 1 · 模型认为仅小胜 1 球仍约 26.8%"
          },
          "win_outlook": {
            "fav_name": "Colombia",
            "state_label": null,
            ...
            "readout_cn": "取胜约 60%；若取胜，以「险胜收工」为主（48.5%）。 对着赛前净胜参考，净胜≥2（全达标）约 28.5%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 38.5%。 注意 2-0 类：净胜扩大但总进球仍可能低于外界参考。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            ...
            "sub_cn": "达标概率约 28.5% · 达标与否难下定论 进球氛围：略倾向沉闷（弱信号）",
            "spread": {
              "level": "uncertain",
              "label_cn": "净胜幅度难下定论",
              "color": "#8A96A8",
              ...
              "verdict_cn": "达标与否难下定论",
              "headline_cn": "Colombia · 净胜走向：达标与否难下定论",
              "pill_cn": "达标概率约 28.5% · 达标与否难下定论",
              "detail_cn": "Colombia · 赛前外界预期 净胜≥2。模型推演达标概率约 28.5%（仅胜 1 球约 26.8%）。",
              "extra_stats_cn": "仅胜 1 球约 26.8%",
              "full_cover_pct": 28.5,
              "half_cover_pct": 0,
              "lose1_pct": 26.8,
              "margin_full_label": "净胜≥2",
          ...
          "first_goal_scenarios": [
            {
              ...
              "big_delta": -17.7,
              "small_delta": -8.9,
              "narrative": "Uzbekistan 先破门（已 1-0） → 「5-4-1 铁桶」；Colombia 「堆前锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            },
            {
              "side": "away",
              ...
              "big_delta": 16.6,
              "small_delta": 9.7,
              "narrative": "Colombia 先破门（已 0-1） → 「控节奏 · 宽度」；Uzbekistan 「维持低位」。领先后双方可能转入守势，比分差距不易再拉大。",
              "live_outlook": {
                "fav_name": "Colombia",
                ...
                "margin_line_cn": "Colombia · 赛前净胜参考 净胜≥2（全达标）",
                "margin_meet_pct": 45.1,
                "margin_half_pct": 0,
                "margin_fail_pct": 36.5,
                "margin_full_label": "净胜≥2",
                "margin_half_label": null,
                "final_2_0_pct": null,
                "final_3_0_plus_pct": null,
                ...
                "model_total_xg": 1.42,
                "totals_line_gap": 0.25,
                "totals_high_pct": 41.4,
                "totals_low_pct": 58.6,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 46.9,
                "win_margin2_low_total_pct": 22.6,
                "win_margin2_high_total_pct": 22.5,
                "readout_cn": "Colombia 已 1-0 领先：仍取胜约 81.6%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 41.4%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            }
          ],
          "match_preview": {
            "morphology": {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 18,
              "readout_cn": "Colombia · 低位反击 · 进球偏少。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
            "draw_trap_note": "平局风险：低位反击队若先进球或被追平，1-1 / 0-0 比客胜更现实（约 18% 冷门空间含平局）。",
            "archetype": {
              "tags": [
        ...
        "public_summary_note": "【推演概要】Colombia · 低位反击 · 进球偏少。 · 与模型 xG 对照：实力吻合 · 赛前净胜看法低于 xG 隐含约 1 · 模型认为仅小胜 1 球仍约 26.8%（模型微调：主胜 +0% · 平 -1% · 客 +1%）",
        "preview_replay": {
          "actual_score": "1-3",
          "ht_score": "1-0",
          "hits": [
      ...
      "group_context": {
        ...
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Uzbekistan 若取胜：积分 3，K 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Colombia 若取胜：积分 6，客场抢分将改变 K 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 L 组：头名 England 3 分 · 次席 Ghana 同分（32强绑定组） · J 组：头名 Argentina 3 分 · 次席 Austria 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。"
        ]
      },
      "actualResult": {
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测（已剔除 Sithole、Zwane 揭幕战红牌停赛）。不计入已确认推演权重。 · 全场 1-1 · FIFA M25 · Sadílek 6' · Mokoena 83' pen",
        "predicted": {
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Czechia 暂列 A 组第 3（1 分 · 已赛 2 场） vs South Africa 第 4（1 分 · 已赛 2 场）；组内 Mexico 6分、South Korea 3分 领先；直接对话权重极高"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前主胜约 54%/最可能 1-0；实际 1-1 平局。Sadílek 6' 领先，Mokoena 83' 点球扳平；Schick 错失良机。方向：主胜未中；平局命中；比分 1-1 在 Top3 边缘"
          }
        ]
      },
      "upset_alert": {
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 54%；若取胜，以「险胜收工」为主（51%）。 对着赛前净胜参考，净胜≥1（全达标）约 54.2%；对着外界总进球参考 总进球约 2–2.5 个，模型终场多于该参考的概率约 46.2%。 注意 2-0 类：净胜扩大但总进球仍可能低于外界参考。"
          },
          "totals_line": 2.25,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.0 球（公允参考约 2.25） · 外界总进球参考 2.25 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "Czechia · 净胜走向：达到预期较有希望",
            "sub_cn": "达标概率约 54.2% · 达到预期较有希望 进球氛围：略倾向沉闷（弱信号）",
            "spread": {
              "level": "likely",
              "label_cn": "达到预期较有希望",
              "color": "#5BBF8A",
              ...
              "verdict_cn": "达到预期较有希望",
              "headline_cn": "Czechia · 净胜走向：达到预期较有希望",
              "pill_cn": "达标概率约 54.2% · 达到预期较有希望",
              "detail_cn": "Czechia · 赛前外界预期 净胜≥1。模型推演达标概率约 54.2%；模型认为达到外界预期档的概率相对较高。",
              "extra_stats_cn": "",
              "full_cover_pct": 54.2,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "Czechia 已 1-0 领先：仍取胜约 77.9%。 对着外界总进球参考 总进球约 2–2.5 个，模型终场多于该参考的概率约 61.9%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
          ...
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.0 球（公允参考约 2.25） · 外界总进球参考 2.25 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2–2.5 个",
              "totals_high_pct": 46.2,
              "type_tags": [
                {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 24,
              "readout_cn": "Czechia · 低位反击 · 进球偏少。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
            "draw_trap_note": "平局风险：低位反击队若先进球或被追平，1-1 / 0-0 比客胜更现实（约 24% 冷门空间含平局）。",
            "archetype": {
              "tags": [
        ...
        "public_summary_note": "【推演概要】Czechia · 低位反击 · 进球偏少。 · 与模型 xG 对照：实力吻合 · 赛前净胜看法高于 xG 隐含约 0.5（模型微调：主胜 +2% · 平 -1% · 客 -1%）",
        "preview_replay": {
          "actual_score": "1-1",
          "ht_score": "1-0",
          "hits": [
      ...
      "group_context": {
        ...
        "scenarios": [
          ...
          "South Africa 若取胜：积分 4，客场抢分将改变 A 组格局与淘汰赛半区。",
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测，不计入已确认推演权重。 · 全场 4-1 · FIFA M26 · 四球均来自替补/补时阶段",
        "predicted": {
          "formation": "4-2-3-1 / 4-3-3",
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Switzerland 暂列 B 组第 2（4 分 · 已赛 2 场） vs Bosnia and Herzegovina 第 3（1 分 · 已赛 2 场）"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前主胜约 50%/最可能 2-0 或 1-1；实际 4-1 瑞士大胜。替补 Manzambi 双响+Vargas，Mahmić 90+3' 扳回，Xhaka 点球。方向：主胜命中；比分未中；总进球偏多"
          }
        ]
      },
      "upset_alert": {
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 50%；若取胜，以「险胜收工」为主（49.2%）。 对着赛前净胜参考，净胜≥1（全达标）约 48.7%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 47.8%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "Switzerland 已 1-0 领先：仍取胜约 74.9%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 49.3%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
          ...
          "match_preview": {
            "morphology": {
              ...
              "depth_label": "深度一般",
              "draw_trap_pct": 28,
              "readout_cn": "Switzerland · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
        ...
        "public_summary_note": "【推演概要】Switzerland · 低位反击。 · 与模型 xG 对照：实力吻合 · 赛前净胜看法略高（约 +0.25）（模型微调：主胜 +2% · 平 -1% · 客 -1%）",
        "preview_replay": {
          "actual_score": "4-1",
          "ht_score": "0-0",
          "hits": [
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "focus_team": null,
          "reason": "本组或关联组积分胶着，第 2、3 轮可能出现算分踢法；本轮仍应以抢分为主。",
          "optimal_summary": "策略最优解（推演）：关联组形势胶着，本场 Switzerland 取胜最能巩固主动，Bosnia and Herzegovina 则需积极抢 3 分；若握手各取 1 分，对领先方尚可接受，对追赶方则略偏保守——此阶段仍以全力争胜、抢 3 分为上策；尚未到以演练或轮换为名调整名次、接受非胜结果的窗口。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Switzerland 若取胜：积分 7，B 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Bosnia and Herzegovina 若取胜：积分 4，客场抢分将改变 B 组格局与淘汰赛半区。",
    ...
    },
    {
      ...
      "lineup": {
        ...
        "home": "等待官方确认",
        "away": "等待官方确认",
        "note": "官方首发尚未确认；下方为媒体预测，不计入已确认推演权重。 · 全场 6-0 · FIFA M27 · David 3 球 · Saliba 举 Koné 8 号球衣庆祝",
        "predicted": {
          "formation": "4-3-3 / 4-2-3-1",
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Canada 暂列 B 组第 1（4 分 · 已赛 2 场） vs Qatar 第 4（1 分 · 已赛 2 场）"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前主胜约 55%/最可能 2-0；实际 6-0 历史性大胜。David 帽子戏法，Larin+Saliba+乌龙；Koné 重伤。方向：主胜命中；比分远超预期；东道主碾压"
          }
        ]
      },
      "upset_alert": {
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 50%；若取胜，以「险胜收工」为主（50.9%）。 对着赛前净胜参考，净胜≥2（全达标）约 25.5%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 36.4%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "summary_cn": "模型 xG 合计约 2.1 球（公允参考约 2.25） · 外界总进球参考 2.5，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向"
          },
          "customer_reading": {
            "headline_cn": "Canada · 净胜走向：达到预期难度偏大",
            "sub_cn": "达标概率约 25.5% · 达到预期难度偏大 进球氛围：略倾向沉闷（弱信号）",
            "spread": {
              "level": "skeptical",
              "label_cn": "外界预期偏高",
              "color": "#D95F6A",
              ...
              "verdict_cn": "达到预期难度偏大",
              "headline_cn": "Canada · 净胜走向：达到预期难度偏大",
              "pill_cn": "达标概率约 25.5% · 达到预期难度偏大",
              "detail_cn": "Canada · 赛前外界预期 净胜≥2。模型推演达标概率约 25.5%；外界看法高于 xG 隐含约 0.75 球，达到预期难度偏大。",
              "extra_stats_cn": "",
              "full_cover_pct": 25.5,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "Canada 已 1-0 领先：仍取胜约 81.7%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 52.5%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
          ...
          "match_preview": {
            "morphology": {
              "totals_summary": "模型 xG 合计约 2.1 球（公允参考约 2.25） · 外界总进球参考 2.5，高出模型约 0.25 球 · 模型在常见进球预期附近均衡，不作强倾向",
              "totals_line_cn": "总进球约 2.5 个",
              "totals_high_pct": 36.4,
              "type_tags": [
                {
              ...
              "depth_label": "板凳深度偏高",
              "draw_trap_pct": 18,
              "readout_cn": "Canada · 低位反击 · 进球偏少。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
            "draw_trap_note": "平局风险：低位反击队若先进球或被追平，1-1 / 0-0 比客胜更现实（约 18% 冷门空间含平局）。",
            "archetype": {
              "tags": [
        ...
        "public_summary_note": "【推演概要】Canada · 低位反击 · 进球偏少。 · 与模型 xG 对照：大众心理预期偏高 · 赛前净胜看法高于 xG 隐含约 0.75（模型微调：主胜 -4% · 平 +1% · 客 +3%）",
        "preview_replay": {
          "actual_score": "6-0",
          "ht_score": "3-0",
          "hits": [],
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "focus_team": null,
          "reason": "本组或关联组积分胶着，第 2、3 轮可能出现算分踢法；本轮仍应以抢分为主。",
          "optimal_summary": "策略最优解（推演）：关联组形势胶着，本场 Canada 取胜最能巩固主动，Qatar 则需积极抢 3 分；若握手各取 1 分，对领先方尚可接受，对追赶方则略偏保守——此阶段仍以全力争胜、抢 3 分为上策；尚未到以演练或轮换为名调整名次、接受非胜结果的窗口。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Canada 若取胜：积分 7，B 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "✅ FIFA 官方 team sheet（Match 28 · 400021442 · 2026-06-19T00:21:10+08:00） · 全场 1-0 · FIFA M28 · Luis Romo 50' · 墨西哥 6 分领跑 A 组",
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Mexico 暂列 A 组第 1（6 分 · 已赛 2 场） vs South Korea 第 2（3 分 · 已赛 2 场）"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前略势均力敌/最可能 2-1 或 1-1；实际 1-0 墨西哥小胜。Romo 50' 利用 Kim 失误破门；韩国未能扳平。方向：主胜命中；比分 1-0 在分布内；墨西哥锁定出线"
          }
        ]
      },
      "upset_alert": {
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 42%；若取胜，以「险胜收工」为主（55.6%）。 对着赛前净胜参考，净胜≥1（全达标）约 38%；对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 46.4%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            ...
            "sub_cn": "达标概率约 38% · 有达标可能 进球氛围：几乎五五开",
            "spread": {
              "level": "possible",
              "label_cn": "有达标可能",
              "color": "#C8A96E",
              ...
              "verdict_cn": "有达标可能",
              "headline_cn": "Mexico · 净胜走向：有达标可能",
              "pill_cn": "达标概率约 38% · 有达标可能",
              "detail_cn": "Mexico · 赛前外界预期 净胜≥1。模型推演达标概率约 38%；有一定达标空间，但非高把握。",
              "extra_stats_cn": "",
              "full_cover_pct": 38,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "win_margin2_high_total_pct": 16.4,
                "readout_cn": "Mexico 已 1-0 领先：仍取胜约 67.2%。 对着外界总进球参考 总进球约 2.5 个，模型终场多于该参考的概率约 48.5%。 常见收尾如 2-0（部分扩大；相对外界总进球参考仍偏少）。"
              }
            },
            {
              "side": "away",
          ...
          "match_preview": {
            "morphology": {
              ...
              "depth_label": "板凳深度偏高",
              "draw_trap_pct": 30,
              "readout_cn": "Mexico · 低位反击。总进球走向模型暂无明确倾向；进球时间段娱乐解读见下方「灵力分析」。"
            },
        ...
        "public_summary_note": "【推演概要】Mexico · 低位反击。 · 与模型 xG 对照：均衡 · 赛前净胜看法略高（约 +0.25）（模型微调：主胜 +0% · 平 +0% · 客 +0%）",
        "preview_replay": {
          "actual_score": "1-0",
          "ht_score": "0-0",
          "hits": [
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "focus_team": null,
          "reason": "本组或关联组积分胶着，第 2、3 轮可能出现算分踢法；本轮仍应以抢分为主。",
          "optimal_summary": "策略最优解（推演）：关联组形势胶着，本场 Mexico 取胜最能巩固主动，South Korea 则需积极抢 3 分；若握手各取 1 分，对领先方尚可接受，对追赶方则略偏保守——此阶段仍以全力争胜、抢 3 分为上策；尚未到以演练或轮换为名调整名次、接受非胜结果的窗口。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Mexico 若取胜：积分 9，A 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
