  ...
  "finishedMatches": [
    {
      ...
      "market_snapshot": {
        ...
        "full_cover_pct": null,
        "spread_level": null,
        "spread_market_expect": null,
        "totals_level": null,
        "totals_show_lean": false,
        "totals_lean_side": null
      },
      "depth_calibration": {
        "public_summary_note": null,
        "preview_replay": null,
        "goal_efficiency": {
          "xg_total": 2.6,
          "xg_gap": 1.6,
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "✅ FIFA 官方 team sheet（Match 32 · 400021462 · 2026-06-19T18:15:11+08:00） · 全场 2-0 · FIFA M32 · 连续两场受益于对手乌龙",
        "source": "FIFA Match Centre · api.fifa.com",
        "updated": "2026-06-20T05:14:01+08:00",
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "USA 暂列 D 组第 1（6 分 · 已赛 2 场） vs Australia 第 2（3 分 · 已赛 2 场）"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前无 Pulisic 首发、模型偏小球；实际 2-0 美国零封。Burgess 11' 乌龙 + Freeman 43' 头球；Freese 一门稳。方向：主胜命中；穿 -1 达标；比分低于 xG 大球预期"
          }
        ],
        "base_home_win": 52.3,
        "base_draw": 27,
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "optimal_summary": "策略最优解（推演）：关联组形势胶着，本场 USA 取胜最能巩固主动，Australia 则需积极抢 3 分；若握手各取 1 分，对领先方尚可接受，对追赶方则略偏保守——此阶段仍以全力争胜、抢 3 分为上策；尚未到以演练或轮换为名调整名次、接受非胜结果的窗口。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "USA 若取胜：积分 9，D 组排名有望上升；32 强/16 强槽位随最终名次（第 1/第 2）切换，见下方路径。",
          "Australia 若取胜：积分 6，客场抢分将改变 D 组格局与淘汰赛半区。",
          "平局：双方各 +1 分；在 C 组：头名 Brazil 4 分 · 次席 Morocco 同分（32强绑定组） · G 组：头名 Iran 1 分 · 次席 New Zealand 同分（32强绑定组） 背景下，名次差 1 位可能改变 32 强对手。",
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 48%；若取胜，以「险胜收工」为主（50.3%）。 对着赛前净胜参考，净胜≥2（全达标）约 26%；对着总进球参考 2.5，模型超线概率约 37.8%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            ...
            "sub_cn": "达标概率约 26% · 达到预期难度偏大 进球氛围：略偏闷",
            "spread": {
              "level": "skeptical",
              "label_cn": "外界预期偏高",
              "color": "#D95F6A",
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "USA 已 1-0 领先：仍取胜约 79.7%。 对着总进球参考 2.5，模型超线概率约 41.2%。 常见 2-0 收尾（相对总进球参考 2.5仍偏小比分）。"
              }
            },
            {
              "side": "away",
    ...
    },
    {
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Scotland 暂列 C 组第 3（3 分 · 已赛 2 场） vs Morocco 第 2（4 分 · 已赛 2 场）"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前 xG 接近均势/最可能 1-1；实际 0-1 摩洛哥闪击。Saibari 2' 破门后苏格兰围攻无果。方向：客胜命中；比分 0-1 在分布内；总进球偏少"
          }
        ],
        "base_home_win": 38,
        "base_draw": 26,
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "focus_team": null,
          "reason": "本组或关联组积分胶着，第 2、3 轮可能出现算分踢法；本轮仍应以抢分为主。",
          "optimal_summary": "策略最优解（推演）：关联组形势胶着，本场 Morocco 取胜最能巩固主动，Scotland 则需积极抢 3 分；若握手各取 1 分，对领先方尚可接受，对追赶方则略偏保守——此阶段仍以全力争胜、抢 3 分为上策；尚未到以演练或轮换为名调整名次、接受非胜结果的窗口。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 37%；若取胜，以「险胜收工」为主（61.6%）。 对着赛前净胜参考，净胜≥1（全达标）约 32.3%；对着总进球参考 2.25，模型超线概率约 51.8%。"
          },
          "totals_line": 2.25,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            ...
            "sub_cn": "达标概率约 32.3% · 达标与否难下定论 进球氛围：几乎五五开",
            "spread": {
              "level": "uncertain",
              "label_cn": "净胜幅度难下定论",
              "color": "#8A96A8",
          ...
          "first_goal_scenarios": [
            ...
            },
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "Morocco 已 1-0 领先：仍取胜约 56.6%。 对着总进球参考 2.25，模型超线概率约 68.5%。 常见 2-0 收尾（相对总进球参考 2.25仍偏小比分）。"
              }
            }
          ],
          "match_preview": {
    ...
    },
    {
      ...
      "lineup": {
        ...
        "note": "✅ FIFA 官方 team sheet（Match 29 · 400021457 · 2026-06-20T00:25:18+08:00） · 全场 3-0 · FIFA M29 · 官方 4-4-2 早段破局",
        "source": "FIFA Match Centre · api.fifa.com",
        "updated": "2026-06-20T05:14:01+08:00",
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Brazil 暂列 C 组第 1（4 分 · 已赛 2 场） vs Haiti 第 4（0 分 · 已赛 2 场）；巴西仅积 4 分须先抢分；C↔F 绑定：头名 32强避 F 组头名（荷兰若领跑 F 组）、次席 32强或直碰荷兰，16 强半区相反"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
            "text": "费城夏夜闷热，体感约 30°C · 27°C · 湿度 68% · 降雨概率 30% · 西南风 2级 · 湿热；湿热中等——领先方后段守势体能是隐性变量，利好早段破局的一方（27°C · 20:30 ET 开球 · 湿度 68%）"
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前巴西 -2.5/大小 3.5；实际 3-0 穿盘未打满。Cunha 23'/36' + Vinícius 45+3'；海地 5-4-1 早段崩盘。方向：主胜命中；总球 3（小 3.5）；路径热门爆发"
          }
        ],
        "base_home_win": 64.7,
        "base_draw": 22,
      ...
      "weather": {
        ...
        "weather_factors": [
          {
            "label": "27°C · 20:30 ET 开球",
            "impact": "体感偏高",
            "detail": "北京时间 6月20日 08:30；夏夜仍有余热"
          },
          {
            "label": "湿度 68%",
            "impact": "中",
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "focus_team": null,
          "reason": "本组或关联组积分胶着，第 2、3 轮可能出现算分踢法；本轮仍应以抢分为主。",
          "optimal_summary": "策略最优解（推演）：关联组形势胶着，本场 Brazil 取胜最能巩固主动，Haiti 则需积极抢 3 分；若握手各取 1 分，对领先方尚可接受，对追赶方则略偏保守——此阶段仍以全力争胜、抢 3 分为上策；尚未到以演练或轮换为名调整名次、接受非胜结果的窗口。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
      ...
      "depth_calibration": {
        ...
        "display_summary": {
          ...
          "win_outlook": {
            ...
            "readout_cn": "取胜约 60%；若取胜，以「险胜收工」为主（42.7%）。 对着赛前净胜参考，净胜≥3（全达标）约 16.2%；部分达标净胜=2 约 20.1%；对着总进球参考 3.5，模型超线概率约 21.2%。 2-0 类：净胜扩大但总进球仍可能低于总进球参考 3.5。"
          },
          "totals_line": 3.5,
          "score_patterns": [
            {
          ...
          "totals_view": {
            ...
            "gap_warning": {
              "level": "high",
              "cn": "总进球参考 3.5，合理值 2.25——高于合理值 1.25，模型宜谨慎"
            },
            "totals_outlook": {
              "level": "clear_low",
              "label_cn": "倾向沉闷",
              ...
              "pill_cn": "倾向沉闷",
              "detail_cn": "倾向沉闷——小比分概率高（合理值 2.25）。 警惕参考定得偏高、实际仍走小比分。",
            ...
            "summary_cn": "预测 2.4 · 合理值 2.25 · 总进球参考 3.5（高于合理值 1.25） · ⚠ 高于合理值 1.25 · 进球氛围：倾向沉闷"
          },
          "customer_reading": {
          ...
          "first_goal_scenarios": [
            {
              ...
              "live_outlook": {
                ...
                "readout_cn": "Brazil 已 1-0 领先：仍取胜约 85.5%。 对着总进球参考 3.5，模型超线概率约 19.3%。 常见收尾：2-0 约 24%（部分达标，非全达标）； 3-0+ 约 19.2%（对着 净胜≥3 全达标）。"
              }
            },
            {
              "side": "away",
          ...
          "match_preview": {
            "morphology": {
              "totals_summary": "预测 2.4 · 合理值 2.25 · 总进球参考 3.5（高于合理值 1.25） · ⚠ 高于合理值 1.25 · 进球氛围：倾向沉闷",
              "totals_line_cn": "总进球参考 3.5",
              "totals_high_pct": 21.2,
              "type_tags": [
                {
        ...
        "preview_replay": {
          ...
          "summary_cn": "命中：进球氛围偏沉闷一致。 偏差：净胜全达标超预期（模型曾偏谨慎）。",
          "totals_actual": 3,
          "totals_line": 3.5,
          "spread_level": "skeptical",
    ...
    },
    {
      ...
      "lineup": {
        "confirmed": true,
        "formation": "4-2-3-1 / 4-2-3-1",
        "home": "Uğurcan Çakır; Ferdi Kadıoğlu, Merih Demiral, Abdülkerim Bardakcı, Mert Müldür; Hakan Çalhanoğlu, İsmail Yüksek; Kenan Yıldız, Arda Güler, Yunus Akgün; Kerem Aktürkoğlu",
        "away": "Orlando Gill; Omar Alderete, Juan José Cáceres, Junior Alonso, Gustavo Gómez; Andrés Cubas, Matías Galarza; Julio Enciso, Miguel Almirón, Diego Gómez; Isidro Pitta",
        "note": "✅ FIFA 官方 team sheet（Match 31 · 400021460 · 2026-06-20T02:19:02+08:00） · 全场 0-1 · FIFA M31 · 半场 xG 0.53–0.08 · 72' 大小 2.0 偏小 · 终场 1 球",
        "source": "FIFA Match Centre · api.fifa.com",
        "updated": "2026-06-20T05:14:01+08:00",
      ...
      "home": {
        ...
        "injuries": [
          ...
          },
          {
            "player": "Kenan Yıldız",
            "status": "FIT",
            "note": "FIFA 官方 #11 左路/肋部",
            "confirmed": true
          },
          {
            "player": "Hakan Çalhanoğlu",
            "status": "FIT",
            "note": "FIFA 官方 #10 队长 · 后腰",
            "confirmed": true
          },
          {
        ...
        "injuries": [
          {
            ...
            "status": "RED",
            "note": "FIFA 官方 #10 · 45+3' 直红 · 中场休息时离场 · 下半场无法出战",
            "confirmed": true
          },
          {
            "player": "Matías Galarza",
            "status": "FIT",
            "note": "FIFA 官方 #23 · 2' 首开 · 上半场进球",
            "confirmed": true
          },
          {
            "player": "Julio Enciso",
            "status": "FIT",
            "note": "FIFA 官方 #19 前腰/肋部",
            "confirmed": true
          },
          {
            "player": "Isidro Pitta",
        ...
        "insight_factors": [
          {
            "icon": "📊",
            "label": "小组积分",
            "text": "Türkiye 暂列 D 组第 4（0 分 · 已赛 2 场） vs Paraguay 第 3（3 分 · 已赛 2 场）；美国 6 分已出线 · 澳大利亚 3 分暂列次席；土/巴均为 0 分——本场胜者 3 分仍须末轮再抢分（末轮土对美国 · 澳对巴拉圭），且土耳其首轮 0-2 负澳、相互战绩处劣势"
          },
          {
            "icon": "🌤️",
            "label": "赛场气候",
          ...
          },
          {
            "icon": "⚽",
            "label": "战术与阵容",
            "text": "【赛后复盘】赛前 xG 2.73/铁局主路径；实际 0-1 冷门。Galarza 2' 闪击 + Almirón 45+3' 红 · 10 人守成。方向：客胜命中（约 29%）；热门效率 0；总球 1（小 2.5）。红牌专题：领先方单红→小球铁局（对照 m27 双红崩盘）"
          }
        ],
        "base_home_win": 45.2,
        "base_draw": 25,
      ...
      "group_context": {
        ...
        "manipulation_risk": {
          ...
          "level_cn": "高",
          "focus_team": "Türkiye",
          "reason": "美国 6 分已提前锁定 32 强（M81 头名槽），本场不影响东道主出线。土耳其/巴拉圭均为 0 分——胜者 3 分仍暂列第 3，落后澳大利亚 3 分；末轮土耳其对美国、澳大利亚对巴拉圭须再抢分。土耳其首轮 0-2 负澳大利亚，同分情况下相互战绩处劣势，大比分取胜仍有净胜球/进球数价值。若夺小组第 2：32强 M88 打 G 组第 2（当前倾向 New Zealand）→ 16强 M95 进 J1/H2 走廊。",
          "optimal_summary": "策略最优解（推演）：美国 6 分已出线，本场是土-巴「零分生死战」——非胜结果几乎等同于放弃小组前二；取胜亦仅至 3 分，仍落后于澳大利亚 3 分且首轮 0-2 相互战绩处劣势。末轮土耳其对美国须再抢分，并需澳大利亚对巴拉圭失分；现阶段绝无演练或接受平局的空间。"
        },
        "knockout_note": "48 队制：12 组各前 2（24 支）+ 12 个小组第 3 中成绩最好的 8 支 = 32 强起淘汰赛（非以往 32 队直接 16 强）；第 3 名横向比积分→净胜球→进球。C↔F 等绑定组末轮或算分选半区。",
        "scenarios": [
          "Türkiye 若取胜：积分 3，暂列第 3；仍落后澳大利亚 3 分且相互战绩处劣势——须末轮对美国再抢分，并盼澳大利亚对巴拉圭失分；若最终小组第 2 → 32强 M88 打 G 组第 2（倾向 New Zealand）→ 16强 M95。",
          "Paraguay 若取胜：同样 3 分，出线形势与土耳其镜像；末轮澳大利亚对巴拉圭为直接对话。",
          "平局：双方各 1 分——在「美国 6 分已出线、澳大利亚 3 分占次席」背景下，1 分对土/巴均几乎无出线价值。",
          "负者：继续 0 分垫底，小组前二希望渺茫；第 3 名争八需极端赛果组合，基本出局。",
          "末轮赛程：土耳其 vs 美国（东道主或轮换但仍须防丢分）· 澳大利亚 vs 巴拉圭——土耳其须末轮两战全胜且澳大利亚末轮失分，方有机会逆转次席。"
        ]
      },
      "depth_calibration": {
        "tier_home": 0.5,
        ...
        "display_summary": {
          ...
          "win_shape": {
            "fav_name": "Türkiye",
            "note": "以下为模型在「该队取胜」假设下的路径分布，三项合计 100%。",
            "lead_cn": "取胜时以险胜·开放为主（险胜 · 开放 27.8%）",
            "shapes": [
              {
                "key": "narrow_low",
                "label": "险胜 · 控局",
          ...
          "xg_context": {
            ...
            "adjusted_home": 1.54,
            "adjusted_away": 1.19,
            "note": "基准 xG 1.54–1.19（未因伤病/气候下调）"
          },
          "calibration": {
            "signal_cn": "实力吻合",
            "signal_color": "#5BBF8A",
          ...
          "win_outlook": {
            ...
            "model_total_xg": 2.73,
            "totals_line_gap": 0.5,
            "totals_high_pct": 51.1,
            "totals_low_pct": 48.9,
            "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
            "win_low_total_pct": 17.9,
            "win_margin2_low_total_pct": 7.8,
            "win_margin2_high_total_pct": 14.7,
            "readout_cn": "取胜约 47%；若取胜，以「险胜收工」为主（50.2%）。 对着赛前净胜参考，净胜≥1（全达标）约 45.2%；对着总进球参考 2.5，模型超线概率约 51.1%。"
          },
          "totals_line": 2.5,
          "score_patterns": [
            {
          ...
          "customer_reading": {
            ...
            "sub_cn": "达标概率约 45.2% · 有达标可能 进球氛围：几乎五五开",
            "spread": {
              "level": "possible",
              "label_cn": "有达标可能",
              "color": "#C8A96E",
              ...
              "verdict_cn": "有达标可能",
              "headline_cn": "Türkiye · 净胜走向：有达标可能",
              "pill_cn": "达标概率约 45.2% · 有达标可能",
              "detail_cn": "Türkiye · 赛前外界预期 净胜≥1。模型推演达标概率约 45.2%；有一定达标空间，但非高把握。",
              "extra_stats_cn": "",
              "full_cover_pct": 45.2,
              "half_cover_pct": 0,
              "lose1_pct": 0,
          ...
          "first_goal_scenarios": [
            {
              ...
              "excitement": {
                ...
                "label_key": "slow",
                "label_color": "#7BB8D4",
                "sub_cn": "预期首球等待约 42.3 分",
                "first_goal_wait": 42.3,
                "fast_pct": 44.1,
                "moderate_pct": 14.1,
                "slow_pct": 41.8,
                "tiers": [
              ...
              "live_outlook": {
                ...
                "model_total_xg": 1.75,
                "totals_line_gap": 0.25,
                "totals_high_pct": 52.1,
                "totals_low_pct": 47.9,
                "totals_fail_note": "常见：总进球 ≤2（如 1-0、2-0）",
                "win_low_total_pct": 34.2,
                "win_margin2_low_total_pct": 16.7,
                "win_margin2_high_total_pct": 21.3,
                "readout_cn": "Türkiye 已 1-0 领先：仍取胜约 71.4%。 对着总进球参考 2.5，模型超线概率约 52.1%。 常见 2-0 收尾（相对总进球参考 2.5仍偏小比分）。"
              }
            },
            {
              "side": "away",
              ...
              "big_delta": -13.4,
              "small_delta": -7.4,
              "narrative": "Paraguay 先破门（已 0-1） → 「10 人深度退守」；Türkiye 「堆前锋」。领先方收缩、落后方压上，比赛更开放；净胜两球以上仍取决于热门能否连续破门。",
              "live_outlook": null
            }
          ],
          "match_preview": {
      ...
      "coach_analysis": {
        "home": {
          ...
          "when_trailing": {
            "label": "堆前锋",
            "detail": "半场 0-1：Montella 必在 46' 前后变阵加码（Yıldız/Güler/Aktürkoğlu）。"
          },
          "vs_strong": {
            "label": "对强队：对攻",
            "detail": "对澳大利亚已暴露效率问题。"
        ...
        "away": {
          ...
          "when_leading": {
            "label": "10 人深度退守",
            "detail": "半场 1-0 且 Almirón 红牌离场——预计 4-5-1/5-4-0，Enciso 回撤。"
          },
          "when_trailing": {
            "label": "堆边锋",
